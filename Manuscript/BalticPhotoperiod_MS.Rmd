...
We calibrated the *JV*~PSII~ estimator to absolute rates of electron transport using parallel measures of oxygen evolution (µmolO~2~ L^−1^ s^−1^), below light saturation, captured using a FireSting robust oxygen probe (PyroScience, Germany) inserted in the cuvette for some RLC runs (Fig. \@ref(fig:LIFT)). 

For blue LED (Ex~445nm~) excitation we used Eq. \@ref(eq:JVPSII445); for orange LED (Ex~590nm~) excitation we used Eq. \@ref(eq:JVPSII590).
