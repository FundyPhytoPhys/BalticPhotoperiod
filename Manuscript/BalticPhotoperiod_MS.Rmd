...
We performed three-way factorial ANOVA to determine whether peak PAR, photoperiod, strain, and their interactions, significantly influence the chlorophyll specific exponential growth rate (µ; d^−1^), estimated from logistic fits of chlorophyll proxy OD~680~ – OD~720~ vs. cumulative diel PUR (Table S3, Sxxx).
