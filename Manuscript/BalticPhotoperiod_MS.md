...
We calculated a fluorescence estimator for volumetric electron transport, *JV*~PSII~, (e^−^ L^−1^ s^−1^) under both 445 and 590 nm excitation bands [@oxboroughDirectEstimationFunctional2012; @boatmanImprovingAccuracySingle2019; @tortellUserGuideApplication2021].
