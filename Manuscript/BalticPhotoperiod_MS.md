...
Using whole-cell absorbance spectra of *Synechococcus* sp. cultures (Fig. <a href="#fig:OlisSpectra">2</a>) we estimated Photosynthetically Usable Radiation (PUR) according to [@morelAvailableUsableStored1978]. We normalized the obtained whole-cell absorbances (A~440nm~) and the emission spectra of the white LED lamps (Em~440nm~) to a reference wavelength of 440 nm. PUR is then the ratio of the normalized sum of absorbance (A~440nm~) and normalized sum of emission spectra (Em~440nm~) to the sum of the normalized emission spectra (Em~440nm~) multiplied by the PAR (Eq. (1)).
