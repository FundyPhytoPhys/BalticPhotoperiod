...
Genetics_cap<- glue("Phylogenetic tree for tested picocyanobacteria.", .sep = " ")
knitr::include_graphics(file.path(FiguresFP, "SFig_GeneticsThatWillBeDoneSoon.png"))
```
