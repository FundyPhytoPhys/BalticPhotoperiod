...
SolFitsTrimOS<-SolFitsTrimOS %>% 
  select(c(SampleID, Time__mSec, Fo, Fm, Fv, FvFm, Tau1QA, Tau2QA, Tau3QA, Alp1QA, Alp2QA, Alp3QA, Alpha, Ek, Pmax, Filename, ObsDate, ObsTime, ObsDateTime, Ex_WL, StartDateTimeSol, nm445, nm470, nm505, nm535, nm590, IR, TempCont, Sig))
...
```{r save rds}
saveRDS(SolFitsOSNS, file.path(DataOut, paste(Project, "Imported_SolisenseLightLRC.Rds", sep = "_"), fsep = .Platform$file.sep), ascii = FALSE, version = NULL, compress = "xz", refhook = NULL)
...
SolFitsTrimMeta <- CultureCatalog %>%
...
SolFitsTrimMeta <- SolFitsTrimMeta %>%
  group_by(SourceDataFile, Filename, SampleID, ObsDate, Ex_WL, TempCont) %>%
