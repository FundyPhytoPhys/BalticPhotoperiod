...
SolFitsTrimMetaDarkafterLight30 <- SolFitsMeta %>%
  filter(Dark1s == 1) %>%
  filter(ActPAR == 0) %>%
  filter(Par_ue == 30) %>%
...
SolFitsTrimMetaDarkafterLight90 <- SolFitsMeta %>%
  filter(Dark1s == 1) %>%
  filter(ActPAR == 0) %>%
  filter(Par_ue == 90) %>%
...
SolFitsTrimMetaDarkafterLight180 <- SolFitsMeta %>%
  filter(Dark1s == 1) %>%
  filter(ActPAR == 0) %>%
  filter(Par_ue == 180) %>%
...
SolFitsTrimMetaDarkafterLight300 <- SolFitsMeta %>%
  filter(Dark1s == 1) %>%
  filter(ActPAR == 0) %>%
  filter(Par_ue == 300) %>%
...
SolFitsTrimMetaDarkafterLight900 <- SolFitsMeta %>%
  filter(Dark1s == 1) %>%
  filter(ActPAR == 0) %>%
