...
MCImportAll %>%
 ...
 #filter(time >48) %>% 
  filter(Run != 77) %>% 
  ggplot() +
  geom_point(aes(x = time, y = mu_deltaODwindow), colour = "seagreen4", alpha = 0.2, show.legend = T) +
...
MCImportAll %>%
 ...
 #filter(time >48) %>% 
  filter(Run != 77) %>% 
  ggplot() +
  geom_point(aes(x = time, y = mu_deltaODwindow), colour = "palegreen3", alpha = 0.2, show.legend = T) +
  geom_line(aes(x = time, y = svr_pred, colour = as.factor(Strain)), size = 0.6, show.legend = F) +
    geom_vline(aes(xintercept = 1 * 24), linetype = "dotted", alpha = 0.4) + 
    geom_vline(aes(xintercept = 2 * 24), linetype = "dotted", alpha = 0.4) + 
    geom_vline(aes(xintercept = 3 * 24), linetype = "dotted", alpha = 0.4) + 
...
MCImportAll %>%
 ...
 #filter(time >48) %>% 
  filter(Run != 77) %>% 
  ggplot() +
  geom_point(aes(x = time, y = mu_deltaODwindow), colour = "brown1", alpha = 0.2, show.legend = T) +
  geom_line(aes(x = time, y = svr_pred, colour = as.factor(Strain)), size = 0.6, show.legend = F) +
    geom_vline(aes(xintercept = 1 * 24), linetype = "dotted", alpha = 0.4) + 
    geom_vline(aes(xintercept = 2 * 24), linetype = "dotted", alpha = 0.4) + 
    geom_vline(aes(xintercept = 3 * 24), linetype = "dotted", alpha = 0.4) + 
...
MCImportAll %>%
 ...
 #filter(time >48) %>% 
  filter(Run != 77) %>% 
  ggplot() +
  geom_point(aes(x = time, y = mu_deltaODwindow), colour = "brown4", alpha = 0.2, show.legend = T) +
  geom_line(aes(x = time, y = svr_pred, colour = as.factor(Strain)), size = 0.6, show.legend = F) +
    geom_vline(aes(xintercept = 1 * 24), linetype = "dotted", alpha = 0.4) + 
    geom_vline(aes(xintercept = 2 * 24), linetype = "dotted", alpha = 0.4) + 
    geom_vline(aes(xintercept = 3 * 24), linetype = "dotted", alpha = 0.4) + 
