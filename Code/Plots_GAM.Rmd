...
GamParaMod = "Lmu"
GamVar = c("WW")
ErrorTolGrowth = 50 # defined for the growth estimates
ErrorTol = 50 # defined for the GAM fit
# OxyLev = 25
...
# "BA48R"  "BA127R" "BA56G"  "BA77G" 
# Plot WL light GAM for BA48R
``` {r BA48RGAM Plot WW WL}
GamStrain = "BA77G" 
#GamColor = "450" may use for Strain colour later
WL_nm = "WW" 
PlotWL <- "deltaOD"
...
(ContourGAM <- ggplot(na.omit(HyperChlPlotHigh), aes(Photoperiod, Par_ue, z = fit, fill = fit)) + 
    geom_tile() +
    ...
    metR::geom_contour2(aes(label = stat(level)),
                        breaks = ContourLines,
                        skip = 0) +
    scale_x_continuous(limits = c(4, 28), breaks = c(4, 8, 12, 16, 24)) +
