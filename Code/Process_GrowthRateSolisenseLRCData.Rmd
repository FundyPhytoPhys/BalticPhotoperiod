...
GrowthRateSoliExp<-GrowthRateSol445 %>% 
  #Turner
  mutate(JVPSII_umol_eLs_Par_ue_Chl = JVPSII_umol_eLs_Par_ue/meanTurChl_ugL) %>% #umole/ugch/s
  mutate(JVPSII_umol_eLs_HalfPar_ue_Chl = JVPSII_umol_eLs_HalfPar_ue/meanTurChl_ugL) %>% 
...
ggplot() +
  geom_point(aes(JVPSII_umol_eLs_Par_ue_Chl, deltaOD_Lmu_corr, colour=as.factor(Par_ue), shape = as.factor(Photoperiod)), alpha = 0.9, size = 3.5, show.legend = T) +
  scale_x_continuous(label=scientific_10) +
...
SolFitsAllPigmentTurnerDay81216<-GrowthRateSoliExp2 %>% 
  ...
  mutate(JVPSII_umol_eLs_Par_ue_Chl_day = JVPSII_umol_eLs_Par_ue_Chl*3600*Photoperiod/2) %>% 
  mutate(JVPSII_umol_eLs_HalfPar_ue_Chl_day = JVPSII_umol_eLs_HalfPar_ue_Chl*3600*Photoperiod/2) %>% 
...
SolFitsAllPigmentTurnerDay900<-GrowthRateSoliExp2 %>% 
  filter(Photoperiod ==24) %>% 
  mutate(JVPSII_umol_eLs_Par_ue_Chl_day = JVPSII_umol_eLs_Par_ue_Chl*3600*Photoperiod) %>% 
  mutate(JVPSII_umol_eLs_HalfPar_ue_Chl_day = JVPSII_umol_eLs_HalfPar_ue_Chl*3600*Photoperiod) %>% 
...
ggplot() +
  geom_point(aes(JVPSII_umol_eLs_Par_ue_Chl_day, deltaOD_Lmu_corr, colour=as.factor(Par_ue), shape = as.factor(Photoperiod)), alpha = 0.9, size = 3.5, show.legend = T) +
  scale_x_continuous(label=scientific_10) +
  #scale_linetype_manual(values=c("equal900" = "dotted", "less900" = "solid"), breaks=c('8', '12', '16', "24", "", "")) +
  scale_colour_manual(values = c("darkslategray", "lightblue4", "hotpink4", "indianred3", "goldenrod2", "khaki2"), name="", labels = lab2, breaks=c('30', "90", "180", "300", "600", "900")) +
  #scale_colour_discrete(type=c("seagreen4", "palegreen3", "brown1", "brown4")) +
...
GrowthRateSoliExpDay %>% 
ggplot() +
  geom_point(aes(JVPSII_umol_eLs_HalfPar_ue_Chl_day, deltaOD_Lmu_corr, colour=as.factor(Par_ue), shape = as.factor(Photoperiod)), alpha = 0.9, size = 3.5, show.legend = T) +
  scale_x_continuous(label=scientific_10) +
  #scale_linetype_manual(values=c("equal900" = "dotted", "less900" = "solid"), breaks=c('8', '12', '16', "24", "", "")) +
  scale_colour_manual(values = c("darkslategray", "lightblue4", "hotpink4", "indianred3", "goldenrod2", "khaki2"), name="", labels = lab2, breaks=c('30', "90", "180", "300", "600", "900")) +
  #scale_colour_discrete(type=c("seagreen4", "palegreen3", "brown1", "brown4")) +
...
MCGrowthJVPSIISPmean<-GrowthRateSoliExpDay %>% 
  drop_na(JVPSII_umol_eLs_Par_ue_Chl_day) %>%
  drop_na(JVPSII_umol_eLs_Par_ue_cell_day) %>%
  select(c(Strain, Par_ue, Photoperiod, O2, WL, deltaOD_Lmu_se, deltaOD_Lmu_corr, facetsStrain, JVPSII_umol_eLs_Par_ue_Chl_day, JVPSII_umol_eLs_HalfPar_ue_Chl_day, JVPSII_umol_eLs_Par_ue_cell_day, JVPSII_umol_eLs_HalfPar_ue_cell_day)) %>% 
  
  group_by(Strain, Par_ue, Photoperiod, O2, WL) %>%
  summarize(Strain, Par_ue, Photoperiod, O2, WL, deltaOD_Lmu_se, deltaOD_Lmu_corr, facetsStrain, JVPSII_umol_eLs_Par_ue_Chl_day, JVPSII_umol_eLs_HalfPar_ue_Chl_day, JVPSII_umol_eLs_Par_ue_cell_day, JVPSII_umol_eLs_HalfPar_ue_cell_day,
    
            meanJVPSII_umol_eLs_Par_ue_Chl_day = mean(JVPSII_umol_eLs_Par_ue_Chl_day),
            sdJVPSII_umol_eLs_Par_ue_Chl_day = sd(JVPSII_umol_eLs_Par_ue_Chl_day),
...
ggplot() +
  geom_point(aes(meanJVPSII_umol_eLs_Par_ue_Chl_day, deltaOD_Lmu_corr, colour = as.factor(Par_ue), shape = as.factor(Photoperiod)), alpha = 0.8, size = 3.5, show.legend = T) +
  scale_x_continuous(label=scientific_10) +
  scale_colour_manual(values = c("darkslategray", "lightblue4", "hotpink4", "indianred3", "goldenrod2", "khaki2"), name="", labels = lab2, breaks=c('30', "90", "180", "300", "600","900")) +
  scale_shape_manual(values = c(15, 16, 17, 18), name="", labels = lab1) +
...
GrowthRateSoliExpDaySmallSP<-GrowthRateSoliExpDay %>% 
  dplyr::select(c(Strain, Par_ue, Photoperiod, O2, WL, deltaOD_Lmu_se, deltaOD_Lmu_corr, facetsStrain, JVPSII_umol_eLs_Par_ue_Chl_day, JVPSII_umol_eLs_HalfPar_ue_Chl_day, JVPSII_umol_eLs_Par_ue_cell_day, JVPSII_umol_eLs_HalfPar_ue_cell_day)) 
...
MCGrowthJVPSIIAllFit <- MCGrowthJVPSIISP %>% 
  ...
  mutate(GRCplatt_Model = map(data, ~nlsLM(deltaOD_Lmu_corr ~ grcplatt(I = JVPSII_umol_eLs_Par_ue_Chl_day, a, b, Pmax), data = .x, start = list(a =0.01/10, b = 1/100, Pmax = 5), lower = c(0, 0, 0)))) %>%  
...
MCGrowthJVPSII12Fit <- MCGrowthJVPSIISP %>% 
  filter(Photoperiod ==12) %>%  
  nest(data = -c("Strain", "facetsStrain")) %>% 
  mutate(GRCplatt_Model = map(data, possibly(~nlsLM(deltaOD_Lmu_corr ~ grcplatt(I = JVPSII_umol_eLs_Par_ue_Chl_day, a, b, Pmax), data = .x, control = list(maxiter = 100), start = list(a =0.01/10, b = 1/100, Pmax = 5), lower = c(0, 0, 0))))) %>%      
  mutate(GRCplatt_Param = map(GRCplatt_Model, tidy),          
         GRCplatt_Predict = map(GRCplatt_Model, possibly(augment)),          
         GRCplatt_Glance = map(GRCplatt_Model, possibly(glance)))
...
MCGrowthJVPSIISP %>% 
ggplot() +
  geom_point(aes(JVPSII_umol_eLs_Par_ue_Chl_day, deltaOD_Lmu_corr, colour = as.factor(Par_ue), shape = as.factor(Photoperiod)), alpha = 0.8, size = 3.5, show.legend = T) +
  geom_line(aes(JVPSII_umol_eLs_Par_ue_Chl_day, .fitted), colour = "blue", size = 0.3, linetype = "solid", show.legend = F, GRCplatt_PredictGrowthJVPSIIAll) +
  geom_line(aes(JVPSII_umol_eLs_Par_ue_Chl_day, .fitted), colour = "darkslategray", linetype = "dashed", show.legend = F, GRCplatt_PredictGrowthJVPSII30) +
  geom_line(aes(JVPSII_umol_eLs_Par_ue_Chl_day, .fitted), colour = "lightblue4", linetype = "dashed", show.legend = F, GRCplatt_PredictGrowthJVPSII90) +
  geom_line(aes(JVPSII_umol_eLs_Par_ue_Chl_day, .fitted), colour = "hotpink4", linetype = "dashed", show.legend = F, GRCplatt_PredictGrowthJVPSII180) +
  geom_line(aes(JVPSII_umol_eLs_Par_ue_Chl_day, .fitted), colour = "indianred3", linetype = "dashed", show.legend = F, GRCplatt_PredictGrowthJVPSII300) +
  geom_line(aes(JVPSII_umol_eLs_Par_ue_Chl_day, .fitted), colour = "goldenrod2", linetype = "dashed", show.legend = F, GRCplatt_PredictGrowthJVPSII900) +
  scale_x_continuous(label=scientific_10) +
  scale_colour_manual(values = c("darkslategray", "lightblue4", "hotpink4", "indianred3", "goldenrod2", "khaki2"), name="", labels = lab2, breaks=c('30', "90", "180", "300", "600","900")) +
  scale_shape_manual(values = c(15, 16, 17, 18), name="", labels = lab1) +
  #labs(y = "Logistic growth rate " ~ "("~d^-1~")", x = "Photon dose ( µmol photons "~m^-2~""~d^-1~")") +
...
ggplot() +
  geom_point(aes(JVPSII_umol_eLs_Par_ue_Chl_day, deltaOD_Lmu_corr, colour = as.factor(Par_ue), shape = as.factor(Photoperiod)), alpha = 0.8, size = 3.5, show.legend = T) +
  geom_line(aes(JVPSII_umol_eLs_Par_ue_Chl_day, .fitted), colour = "blue", size = 0.3, linetype = "solid", show.legend = F, GRCplatt_PredictGrowthJVPSIIAll) +
  geom_line(aes(JVPSII_umol_eLs_Par_ue_Chl_day, .fitted), colour = "black", linetype = "dotted", show.legend = F, GRCplatt_PredictGrowthJVPSII8) +
  geom_line(aes(JVPSII_umol_eLs_Par_ue_Chl_day, .fitted), colour = "black", linetype = "longdash", show.legend = F,  GRCplatt_PredictGrowthJVPSII12) +
  geom_line(aes(JVPSII_umol_eLs_Par_ue_Chl_day, .fitted), colour = "black", linetype = "dashed", show.legend = F,  GRCplatt_PredictGrowthJVPSII16) +
  geom_line(aes(JVPSII_umol_eLs_Par_ue_Chl_day, .fitted), colour = "black", linetype = "dotdash", show.legend = F, GRCplatt_PredictGrowthJVPSII24) +
  scale_x_continuous(label=scientific_10) +
  scale_colour_manual(values = c("darkslategray", "lightblue4", "hotpink4", "indianred3", "goldenrod2", "khaki2"), name="", labels = lab2, breaks=c('30', "90", "180", "300", "600","900")) +
  scale_shape_manual(values = c(15, 16, 17, 18), name="", labels = lab1) +
  #labs(y = "Logistic growth rate " ~ "("~d^-1~")", x = "Photon dose ( µmol photons "~m^-2~""~d^-1~")") +
...
ggplot() +
  ...
  geom_line(aes(JVPSII_umol_eLs_Par_ue_Chl_day, .fitted), colour = "darkslategray", linetype = "dashed", show.legend = F, GRCplatt_PredictGrowth30_BA56) +
  geom_line(aes(JVPSII_umol_eLs_Par_ue_Chl_day, .fitted), colour = "indianred3", linetype = "dashed", show.legend = F, GRCplatt_PredictGrowth300_BA56) +
  geom_line(aes(JVPSII_umol_eLs_Par_ue_Chl_day, .fitted), colour = "goldenrod2", linetype = "dashed", show.legend = F, GRCplatt_PredictGrowth900_BA56) +
  
  geom_line(aes(JVPSII_umol_eLs_Par_ue_Chl_day, .fitted), colour = "goldenrod2", linetype = "dashed", show.legend = F, GRCplatt_PredictGrowth900_BA48) +
  
  geom_line(aes(JVPSII_umol_eLs_Par_ue_Chl_day, .fitted), colour = "darkslategray", linetype = "dashed", show.legend = F, GRCplatt_PredictGrowth30_BA127) +
  geom_line(aes(JVPSII_umol_eLs_Par_ue_Chl_day, .fitted), colour = "goldenrod2", linetype = "dashed", show.legend = F, GRCplatt_PredictGrowth900_BA127) +
  ...
  labs(y = "Chlorophyll specific exponential growth rate " ~ "("~d^-1~")", x = ""~italic(JV)~""["PSII"]*" (µmol"~e^-~""~µg~Chl~italic(a)~""^-1~""~d^-1~")") +
  ggh4x::facet_nested(rows = vars(facetsStrain, Strain), labeller = label_parsed) +
  theme_bw() +
...
ggplot() +
  ...
  geom_line(aes(JVPSII_umol_eLs_Par_ue_Chl_day, .fitted), colour = "black", linetype = "dotted", show.legend = F, GRCplatt_PredictGrowth8_BA56) +
  geom_line(aes(JVPSII_umol_eLs_Par_ue_Chl_day, .fitted), colour = "black", linetype = "dotdash", show.legend = F,  GRCplatt_PredictGrowth24_BA56) +
  
  geom_line(aes(JVPSII_umol_eLs_Par_ue_Chl_day, .fitted), colour = "black", linetype = "dotted", show.legend = F, GRCplatt_PredictGrowth8_BA127) +
...
```{r save plot}
ggsave(file = file.path(FigPath, paste("Fig_GrowthRate_JVPSII_Light_cell",".png",sep = "")), height=9, width= 7,  dpi = 300, limitsize = TRUE)
```
...
```{r save plot}
ggsave(file = file.path(FigPath, paste("Fig_GrowthRate_JVPSII_Photoperiod_cell",".png",sep = "")), height=9, width= 7,  dpi = 300, limitsize = TRUE)
```
