...
ggplot() +
  ...
  scale_x_continuous(breaks=seq(0, 2e05, by = 0.5e05), label=scientific_10) +
  coord_cartesian(xlim = c(0, 2e05)) +
...
PlotBLightJVPSII<-JVPSIIParamAll_Light %>% 
  ...
  coord_cartesian(ylim = c(0, 0.040)) +
...
```{r save plot}
ggsave(file = file.path(FigPath, paste("Fig_GrowthRate_JVPSII_Light_Chla",".png",sep = "")), height=9, width= 12,  dpi = 300, limitsize = TRUE)
```
