...
Solisense %>%
  ...
  filter(Phase == "Exponential") %>% 
  ggplot() +
  geom_point(aes(x = meanTurChl_ugL, y = JVPSII_Par_ue, colour = as.factor(Strain)),  alpha = 0.8, size = 3, show.legend = T) +
  scale_colour_discrete(type=c("seagreen4", "palegreen3", "brown1", "brown4"), name="", labels = lab1) +
  ggh4x::facet_nested(cols = vars(Phase, Photoperiod), rows = vars(Par_ue), labeller = label_parsed) +
  theme_bw() 
...
Solisense %>%
  ...
  filter(Phase == "Exponential") %>% 
  ggplot() +
  geom_point(aes(x = meanCellL_MDPico, y = JVPSII_Par_ue, colour = as.factor(Strain)),  alpha = 0.8, size = 3, show.legend = T) +
  scale_colour_discrete(type=c("seagreen4", "palegreen3", "brown1", "brown4"), name="", labels = lab1) +
  ggh4x::facet_nested(cols = vars(Phase, Photoperiod), rows = vars(Par_ue), labeller = label_parsed) +
  theme_bw() 
```
...
GrowthRateSol<-GrowthRateSol %>% 
  select(-c(data, CellmL_MDPico, TurChl_ugL)) %>% 
  unique()
```
...
GrowthRateSoliExp<-GrowthRateSol445 %>% 
  #Turner
  mutate(JVPSII_Par_ue_Chl = JVPSII_Par_ue/meanTurChl_ugL) %>% #umole/ugch/s
  mutate(JVPSII_HalfPar_ue_Chl = JVPSII_HalfPar_ue/meanTurChl_ugL) %>% 

  #cell per L based on MC OD680 and pamas corr
  mutate(JVPSII_Par_ue_cell = JVPSII_Par_ue/meanCellL_MDPico) %>% 
  mutate(JVPSII_HalfPar_ue_cell = JVPSII_HalfPar_ue/meanCellL_MDPico)  
```
...
MCGrowthJVPSIIAllFit <- MCGrowthJVPSIISP %>% 
  ...
  mutate(GRCplatt_Model = map(data, ~nlsLM(deltaOD_Lmu_corr ~ grcplatt(I = JVPSII_Par_ue_Chl_day, a, b, Pmax), data = .x, start = list(a =0.01/10, b = 1/100, Pmax = 5), lower = c(0, 0, 0)))) %>%  
...
MCGrowthJVPSII12Fit <- MCGrowthJVPSIISP %>% 
  filter(Photoperiod ==12) %>%  
  nest(data = -c("Strain", "facetsStrain")) %>% 
  mutate(GRCplatt_Model = map(data, possibly(~nlsLM(deltaOD_Lmu_corr ~ grcplatt(I = JVPSII_Par_ue_Chl_day, a, b, Pmax), data = .x, control = list(maxiter = 100), start = list(a =0.01/10, b = 1/100, Pmax = 5), lower = c(0, 0, 0))))) %>%      
  mutate(GRCplatt_Param = map(GRCplatt_Model, tidy),          
         GRCplatt_Predict = map(GRCplatt_Model, possibly(augment)),          
         GRCplatt_Glance = map(GRCplatt_Model, possibly(glance)))
...
ggplot() +
  ...
  geom_line(aes(JVPSII_Par_ue_Chl_day, .fitted), colour = "blue", size = 0.3, linetype = "solid", show.legend = F, GRCplatt_PredictGrowthJVPSIIAll) +
  geom_line(aes(JVPSII_Par_ue_Chl_day, .fitted), colour = "darkslategray", linetype = "dashed", show.legend = F, GRCplatt_PredictGrowthJVPSII30) +
  geom_line(aes(JVPSII_Par_ue_Chl_day, .fitted), colour = "lightblue4", linetype = "dashed", show.legend = F, GRCplatt_PredictGrowthJVPSII90) +
  geom_line(aes(JVPSII_Par_ue_Chl_day, .fitted), colour = "hotpink4", linetype = "dashed", show.legend = F, GRCplatt_PredictGrowthJVPSII180) +
  geom_line(aes(JVPSII_Par_ue_Chl_day, .fitted), colour = "indianred3", linetype = "dashed", show.legend = F, GRCplatt_PredictGrowthJVPSII300) +
  geom_line(aes(JVPSII_Par_ue_Chl_day, .fitted), colour = "goldenrod2", linetype = "dashed", show.legend = F, GRCplatt_PredictGrowthJVPSII900) +
  scale_x_continuous(label=scientific_10) +
  scale_colour_manual(values = c("darkslategray", "lightblue4", "hotpink4", "indianred3", "goldenrod2", "khaki2"), name="", labels = lab2, breaks=c('30', "90", "180", "300", "600","900")) +
  scale_shape_manual(values = c(15, 16, 17, 18), name="", labels = lab1) +
...
ggplot() +
  geom_point(aes(JVPSII_Par_ue_Chl_day, deltaOD_Lmu_corr, colour = as.factor(Par_ue), shape = as.factor(Photoperiod)), alpha = 0.8, size = 3.5, show.legend = T) +
  geom_line(aes(JVPSII_Par_ue_Chl_day, .fitted), colour = "blue", size = 0.3, linetype = "solid", show.legend = F, GRCplatt_PredictGrowthJVPSIIAll) +
  geom_line(aes(JVPSII_Par_ue_Chl_day, .fitted), colour = "black", linetype = "dotted", show.legend = F, GRCplatt_PredictGrowthJVPSII8) +
  geom_line(aes(JVPSII_Par_ue_Chl_day, .fitted), colour = "black", linetype = "longdash", show.legend = F,  GRCplatt_PredictGrowthJVPSII12) +
  geom_line(aes(JVPSII_Par_ue_Chl_day, .fitted), colour = "black", linetype = "dashed", show.legend = F,  GRCplatt_PredictGrowthJVPSII16) +
  geom_line(aes(JVPSII_Par_ue_Chl_day, .fitted), colour = "black", linetype = "dotdash", show.legend = F, GRCplatt_PredictGrowthJVPSII24) +
  scale_x_continuous(label=scientific_10) +
  scale_colour_manual(values = c("darkslategray", "lightblue4", "hotpink4", "indianred3", "goldenrod2", "khaki2"), name="", labels = lab2, breaks=c('30', "90", "180", "300", "600","900")) +
  scale_shape_manual(values = c(15, 16, 17, 18), name="", labels = lab1) +
  #labs(y = "Logistic growth rate " ~ "("~d^-1~")", x = "Photon dose ( µmol photons "~m^-2~""~d^-1~")") +
...
GRCplatt_PredictGrowth30_BA56<-GRCplatt_PredictGrowthJVPSII30 %>% 
    filter(Strain == "PC-rich_056")
GRCplatt_PredictGrowth300_BA56<-GRCplatt_PredictGrowthJVPSII90 %>% 
    filter(Strain == "PC-rich_056")
GRCplatt_PredictGrowth900_BA56<-GRCplatt_PredictGrowthJVPSII90 %>% 
    filter(Strain == "PC-rich_056")
...
GRCplatt_PredictGrowth8_BA56<-GRCplatt_PredictGrowthJVPSII8 %>% 
    filter(Strain == "PC-rich_056")
GRCplatt_PredictGrowth24_BA56<-GRCplatt_PredictGrowthJVPSII12 %>% 
    filter(Strain == "PC-rich_056")
...
MCGrowthJVPSIISP %>% 
ggplot() +
  geom_point(aes(JVPSII_Par_ue_Chl_day*1e18, deltaOD_Lmu_corr, colour = as.factor(Par_ue), shape = as.factor(Photoperiod)), alpha = 0.8, size = 3.5, show.legend = T) +
  geom_line(aes(JVPSII_Par_ue_Chl_day*1e18, .fitted), colour = "blue", size = 0.3, linetype = "solid", show.legend = F, GRCplatt_PredictGrowthJVPSIIAll) +
  
  geom_line(aes(JVPSII_Par_ue_Chl_day*1e18, .fitted), colour = "darkslategray", linetype = "dashed", show.legend = F, GRCplatt_PredictGrowth30_BA56) +
  geom_line(aes(JVPSII_Par_ue_Chl_day*1e18, .fitted), colour = "indianred3", linetype = "dashed", show.legend = F, GRCplatt_PredictGrowth300_BA56) +
  geom_line(aes(JVPSII_Par_ue_Chl_day*1e18, .fitted), colour = "goldenrod2", linetype = "dashed", show.legend = F, GRCplatt_PredictGrowth900_BA56) +
  
  geom_line(aes(JVPSII_Par_ue_Chl_day*1e18, .fitted), colour = "goldenrod2", linetype = "dashed", show.legend = F, GRCplatt_PredictGrowth900_BA48) +
  
  geom_line(aes(JVPSII_Par_ue_Chl_day*1e18, .fitted), colour = "darkslategray", linetype = "dashed", show.legend = F, GRCplatt_PredictGrowth30_BA127) +
  geom_line(aes(JVPSII_Par_ue_Chl_day*1e18, .fitted), colour = "goldenrod2", linetype = "dashed", show.legend = F, GRCplatt_PredictGrowth900_BA127) +
  
  scale_x_continuous(label=scientific_10) +
  scale_colour_manual(values = c("darkslategray", "lightblue4", "hotpink4", "indianred3", "goldenrod2", "khaki2"), name="", labels = lab2, breaks=c('30', "90", "180", "300", "600","900")) +
  scale_shape_manual(values = c(15, 16, 17, 18), name="", labels = lab1) +
  # labs(y = "Chlorophyll specific exponential growth rate " ~ "("~d^-1~")", x = ""~italic(JV)~""["PSII"]*" ("~e^-~""~Chla^-1~""~d^-1~")") +
  labs(y = "Chlorophyll specific exponential growth rate " ~ "("~d^-1~")", x = "µmol"~italic(JV)~""["PSII"]*" ("~e^-~""~Chl~italic(a)~""^-1~""~d^-1~")") +
  ggh4x::facet_nested(rows = vars(facetsStrain, Strain), labeller = label_parsed) +
  theme_bw() +
...
```{r save plot}
ggsave(file = file.path(FigPath, paste("Fig_GrowthRate_JVPSII_Light_calib",".png",sep = "")), height=9, width= 7,  dpi = 300, limitsize = TRUE)
```
...
ggplot() +
  ...
  geom_line(aes(JVPSII_Par_ue_Chl_day, .fitted), colour = "black", linetype = "dotted", show.legend = F, GRCplatt_PredictGrowth8_BA56) +
  geom_line(aes(JVPSII_Par_ue_Chl_day, .fitted), colour = "black", linetype = "dotdash", show.legend = F,  GRCplatt_PredictGrowth24_BA56) +
  
  geom_line(aes(JVPSII_Par_ue_Chl_day, .fitted), colour = "black", linetype = "dotted", show.legend = F, GRCplatt_PredictGrowth8_BA127) +
...
```{r save plot}
ggsave(file = file.path(FigPath, paste("Fig_GrowthRate_JVPSII_Photoperiod_calib",".png",sep = "")), height=9, width= 7,  dpi = 300, limitsize = TRUE)
```
...
JVPSIIParamAll_Light %>% 
  ...
  ggh4x::facet_nested(cols = vars(as.numeric(Fit)), rows = vars(Strain), labeller = label_parsed, scales = "free") +
  theme_bw()
...
MCGrowthJVPSIIAllFit <- MCGrowthJVPSIISP %>% 
  nest(data = -c("Strain", "facetsStrain")) %>%  
  mutate(GRCplatt_Model = map(data, ~nlsLM(deltaOD_Lmu_corr ~ grcplatt(I = JVPSII_Par_ue_cell_day, a, b, Pmax), data = .x, start = list(a =0.01/1e-06, b = 1/1e-07, Pmax = 5), lower = c(0, 0, 0)))) %>%  
  mutate(GRCplatt_Param = map(GRCplatt_Model, tidy),          
         GRCplatt_Predict = map(GRCplatt_Model, possibly(augment)),          
         GRCplatt_Glance = map(GRCplatt_Model, possibly(glance)))
GRCplatt_PredictGrowthJVPSIIAll <- MCGrowthJVPSIIAllFit %>% 
...
MCGrowthJVPSII30Fit <- MCGrowthJVPSIISP %>% 
  filter(Par_ue ==30) %>% 
  nest(data = -c("Strain", "facetsStrain")) %>%  
  mutate(GRCplatt_Model = map(data, ~nlsLM(deltaOD_Lmu_corr ~ grcplatt(I = JVPSII_Par_ue_cell_day, a, b, Pmax), data = .x, start = list(a =0.01/1e-02, b = 1/1e-07, Pmax = 5), lower = c(0, 0, 0)))) %>%    
  mutate(GRCplatt_Param = map(GRCplatt_Model, tidy),          
         GRCplatt_Predict = map(GRCplatt_Model, possibly(augment)),          
         GRCplatt_Glance = map(GRCplatt_Model, possibly(glance)))
GRCplatt_PredictGrowthJVPSII30 <- MCGrowthJVPSII30Fit %>% 
...
MCGrowthJVPSII90Fit <- MCGrowthJVPSIISP %>% 
  filter(Par_ue ==90) %>%  
  nest(data = -c("Strain", "facetsStrain")) %>% 
  mutate(GRCplatt_Model = map(data, ~nlsLM(deltaOD_Lmu_corr ~ grcplatt(I = JVPSII_Par_ue_cell_day, a, b, Pmax), data = .x, start = list(a =0.01/1e-07, b = 1/1e-07, Pmax = 5), lower = c(0, 0, 0)))) %>%      
  mutate(GRCplatt_Param = map(GRCplatt_Model, tidy),          
         GRCplatt_Predict = map(GRCplatt_Model, possibly(augment)),          
         GRCplatt_Glance = map(GRCplatt_Model, possibly(glance)))
GRCplatt_PredictGrowthJVPSII90 <- MCGrowthJVPSII90Fit %>% 
...
MCGrowthJVPSII8Fit <- MCGrowthJVPSIISP %>% 
  filter(Photoperiod ==8) %>% 
  nest(data = -c("Strain", "facetsStrain")) %>%  
  mutate(GRCplatt_Model = map(data, ~nlsLM(deltaOD_Lmu_corr ~ grcplatt(I = JVPSII_Par_ue_cell_day, a, b, Pmax), data = .x, start = list(a =0.01/10, b = 1/100, Pmax = 5), lower = c(0, 0, 0)))) %>%    
  mutate(GRCplatt_Param = map(GRCplatt_Model, tidy),          
         GRCplatt_Predict = map(GRCplatt_Model, possibly(augment)),          
         GRCplatt_Glance = map(GRCplatt_Model, possibly(glance)))
GRCplatt_PredictGrowthJVPSII8 <- MCGrowthJVPSII8Fit %>% 
...
MCGrowthJVPSII12Fit <- MCGrowthJVPSIISP %>% 
  filter(Photoperiod ==12) %>%  
  nest(data = -c("Strain", "facetsStrain")) %>% 
  mutate(GRCplatt_Model = map(data, possibly(~nlsLM(deltaOD_Lmu_corr ~ grcplatt(I = JVPSII_Par_ue_cell_day, a, b, Pmax), data = .x, control = list(maxiter = 100), start = list(a =0.01/10, b = 1/100, Pmax = 5), lower = c(0, 0, 0))))) %>%      
  mutate(GRCplatt_Param = map(GRCplatt_Model, tidy),          
         GRCplatt_Predict = map(GRCplatt_Model, possibly(augment)),          
         GRCplatt_Glance = map(GRCplatt_Model, possibly(glance)))
GRCplatt_PredictGrowthJVPSII12 <- MCGrowthJVPSII12Fit %>% 
...
MCGrowthJVPSII16Fit <- MCGrowthJVPSIISP %>% 
  filter(Photoperiod ==16) %>%  
  nest(data = -c("Strain", "facetsStrain")) %>%  
  mutate(GRCplatt_Model = map(data, ~nlsLM(deltaOD_Lmu_corr ~ grcplatt(I = JVPSII_Par_ue_cell_day, a, b, Pmax), data = .x, start = list(a =0.01/10, b = 1/5, Pmax = 100), lower = c(0, 0, 0)))) %>%    
  mutate(GRCplatt_Param = map(GRCplatt_Model, tidy),          
         GRCplatt_Predict = map(GRCplatt_Model, possibly(augment)),          
         GRCplatt_Glance = map(GRCplatt_Model, possibly(glance)))
GRCplatt_PredictGrowthJVPSII16 <- MCGrowthJVPSII16Fit %>% 
