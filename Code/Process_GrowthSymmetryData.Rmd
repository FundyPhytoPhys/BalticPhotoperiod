...
data_text_AnovaSt<- data.frame(WL = c("WW", "WW"), Phase = c("Pre-stationary"), O2=c(21, 21, 21, 21), Strain  = c("PC-rich_056", "PC-rich_077", "PE-rich_048", "PE-rich_127"),  label = c('ANOVA, \u03B1 = 0.05, a', ' ANOVA, \u03B1 = 0.05, ab', ' ANOVA, \u03B1 = 0.05, ab', 'ANOVA, \u03B1 = 0.05, b'))
...
```{r save plot}
ggsave(file = file.path(FigPath, paste("SFig_TDG",".png",sep = "")), height=10, width= 8,  dpi = 300, limitsize = TRUE)
```
