...
lab2=c(expression("30 µE"), expression("90 µE"), expression("180 µE"), expression("300 µE"), expression("900 µE"))
  ...
  geom_text(data=data_text_AnovaSt77P, aes(x=8000000, y=0.2, label=label), colour = "blue", size=4) +
  ...
  geom_text(data=data_text_AnovaPhase, aes(x=6000000, y=-0.1, label=label), colour = "blue", size=4) +
