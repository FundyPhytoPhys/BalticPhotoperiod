...
GrowthRateAll <- GrowthRate_h %>% 
  left_join(., GrowthRate, by = c("SampleID"="SampleID", "Run"="Run", "Strain"="Strain", "Tube" = "Tube",  "Par_ue"="Par_ue","Photoperiod"="Photoperiod", "O2"="O2", "WL"="WL")) 
```


# Create preliminary plot - issue - missing one point when was no growth - N/A issue? Fix this Sylwia!
...
GrowthRateAll %>%
  ...
  theme_bw()
```
# issue - add to process solisenda Turner data!!!! 
# issue - import solisense again to get hours of measurements!!!!!!
...
GrowthRateSoliExp <- GrowthRate %>% 
  left_join(., Solisense, by = c("SampleID"="SampleID", "Run"="Run",  "Strain"="Strain", "Tube" = "Tube", "MC"="MC",  "ExpDate"="ExpDate", "Par_ue"="Par_ue","Photoperiod"="Photoperiod", "O2"="O2", "WL"="WL", "PARPhotonDose_day"="PARPhotonDose_day", "LightShape" = "LightShape", "FilenameMC" = "FilenameMC", "ExpEndDate"= "ExpEndDate")) 
