...
Maybe merge with time - think how to do this Sylwia!!!!!!

# Merge Growth rate and Solisense

```{r Joining growth rate and Solisense exp data}
GrowthRateSoliExp <- GrowthRateAll %>% 
  full_join(., Solisense, by = c("SampleID"="SampleID", "Run"="Run",  "Strain"="Strain", "ExpDate"="ExpDate", "Par_ue"="Par_ue","Photoperiod"="Photoperiod", "O2"="O2", "WL"="WL", "PARPhotonDose_day"="PARPhotonDose_day", "Day" = "E_days")) 
