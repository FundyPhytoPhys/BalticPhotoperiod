...
GrowthRateSoliExp<-GrowthRateSoliExp %>% 
  ...
  mutate(JVPSII_aLHIIOxbomax_Corrcell = JVPSII_aLHIIOxbomax/AllmeancellL_OD680) %>% 
  mutate(JVPSII_ETRtauav_FoSig_Corrcell = JVPSII_ETRtauav_FoSig/AllmeancellL_OD680) %>% 
  mutate(JVPSII_ETRqpOxbo_FoSig_Corrcell = JVPSII_ETRqpOxbo_FoSig/AllmeancellL_OD680) %>% 
  mutate(JVPSII_ETRtauav_aLHII_Sig_Corrcell = JVPSII_ETRtauav_aLHII_Sig/AllmeancellL_OD680) %>% 
  mutate(JVPSII_ETRqpOxbo_aLHII_Sig_Corrcell = JVPSII_ETRqpOxbo_aLHII_Sig/AllmeancellL_OD680) %>% 
  ...
  mutate(AllmeanJVPSII_aLHIIOxbomax_Corrcell = AllmeanJVPSII_aLHIIOxbomax/AllmeancellL_OD680) %>%
  mutate(AllmeanJVPSII_ETRtauav_FoSig_Corrcell = AllmeanJVPSII_ETRtauav_FoSig/AllmeancellL_OD680) %>%
  mutate(AllmeanJVPSII_ETRqpOxbo_FoSig_Corrcell = AllmeanJVPSII_ETRqpOxbo_FoSig/AllmeancellL_OD680) %>%
  mutate(AllmeanJVPSII_ETRtauav_aLHII_Sig_Corrcell = AllmeanJVPSII_ETRtauav_aLHII_Sig/AllmeancellL_OD680) %>%
  mutate(AllmeanJVPSII_ETRqpOxbo_aLHII_Sig_Corrcell = AllmeanJVPSII_ETRqpOxbo_aLHII_Sig/AllmeancellL_OD680)
```
...
GrowthRateSoliExp %>% 
  filter(Ex_WL==445) %>% 
ggplot() +
  geom_point(aes(AllmeanJVPSII_ETRqpOxbo_aLHII_Sig_Corrcell, deltaOD_Lmu_corr, colour=as.factor(Par_ue), shape = as.factor(Photoperiod)), alpha = 0.9, size = 3.5, show.legend = T) +
  scale_x_continuous(label=scientific_10) +
  #scale_linetype_manual(values=c("equal900" = "dotted", "less900" = "solid"), breaks=c('8', '12', '16', "24")) +
  scale_colour_manual(values = c("darkslategray", "lightblue4", "hotpink4", "indianred3", "goldenrod2", "khaki2"), name="", labels = lab2, breaks=c('30', "90", "180", "300", "600", "900")) +
  #scale_colour_discrete(type=c("seagreen4", "palegreen3", "brown1", "brown4")) +
...
SolFitsAllPigmentTurnerDay81216<-GrowthRateSoliExp %>% 
  ...
  mutate(JVPSII_ETRqpOxbo_aLHII_Sig_Corrcell_day = JVPSII_ETRqpOxbo_aLHII_Sig_Corrcell*3600*Photoperiod/2) %>% 
  ...
  mutate(AllmeanJVPSII_ETRqpOxbo_aLHII_Sig_Corrcell_day = AllmeanJVPSII_ETRqpOxbo_aLHII_Sig_Corrcell*3600*Photoperiod/2) 
...
SolFitsAllPigmentTurnerDay %>% 
  filter(Ex_WL==445) %>% 
ggplot() +
  geom_point(aes(JVPSII_aLHIIOxbomax_Corrcell_day, deltaOD_Lmu_corr, colour=as.factor(Par_ue)), alpha = 0.9, size = 3.5, show.legend = T) +
  scale_x_continuous(label=scientific_10) +
  #scale_linetype_manual(values=c("equal900" = "dotted", "less900" = "solid"), breaks=c('8', '12', '16', "24", "", "")) +
  scale_colour_manual(values = c("darkslategray", "lightblue4", "hotpink4", "indianred3", "goldenrod2", "khaki2"), name="", labels = lab2, breaks=c('30', "90", "180", "300", "600", "900")) +
  #scale_colour_discrete(type=c("seagreen4", "palegreen3", "brown1", "brown4")) +
...
SolFitsAllPigmentTurnerDay %>% 
  filter(Ex_WL==445) %>% 
ggplot() +
  geom_point(aes(JVPSII_ETRtauav_FoSig_Corrcell_day, deltaOD_Lmu_corr, colour=as.factor(Par_ue)), alpha = 0.9, size = 3.5, show.legend = T) +
  scale_x_continuous(label=scientific_10) +
  scale_colour_manual(values = c("darkslategray", "lightblue4", "hotpink4", "indianred3", "goldenrod2", "khaki2"), name="", labels = lab2, breaks=c('30', "90", "180", "300", "600", "900")) +
  #scale_colour_discrete(type=c("seagreen4", "palegreen3", "brown1", "brown4")) +
  scale_shape_manual(values = c(15, 16, 17, 18), name="", labels = lab1) +
...
SolFitsAllPigmentTurnerDay %>% 
  filter(Ex_WL==445) %>% 
ggplot() +
  geom_point(aes(JVPSII_ETRqpOxbo_FoSig_Corrcell_day, deltaOD_Lmu_corr, colour=as.factor(Par_ue)), alpha = 0.9, size = 3.5, show.legend = T) +
  scale_x_continuous(label=scientific_10) +
  scale_colour_manual(values = c("darkslategray", "lightblue4", "hotpink4", "indianred3", "goldenrod2", "khaki2"), name="", labels = lab2, breaks=c('30', "90", "180", "300", "600", "900")) +
  #scale_colour_discrete(type=c("seagreen4", "palegreen3", "brown1", "brown4")) +
  scale_shape_manual(values = c(15, 16, 17, 18), name="", labels = lab1) +
...
SolFitsAllPigmentTurnerDay %>% 
  filter(Ex_WL==445) %>% 
ggplot() +
  geom_point(aes(JVPSII_ETRtauav_aLHII_Sig_Corrcell_day, deltaOD_Lmu_corr, colour=as.factor(Par_ue)), alpha = 0.9, size = 3.5, show.legend = T) +
  scale_x_continuous(label=scientific_10) +
  scale_colour_manual(values = c("darkslategray", "lightblue4", "hotpink4", "indianred3", "goldenrod2", "khaki2"), name="", labels = lab2, breaks=c('30', "90", "180", "300", "600", "900")) +
  #scale_colour_discrete(type=c("seagreen4", "palegreen3", "brown1", "brown4")) +
  scale_shape_manual(values = c(15, 16, 17, 18), name="", labels = lab1) +
...
SolFitsAllPigmentTurnerDay %>% 
  filter(Ex_WL==445) %>% 
ggplot() +
  geom_point(aes(JVPSII_ETRqpOxbo_aLHII_Sig_Corrcell_day, deltaOD_Lmu_corr, colour=as.factor(Par_ue)), alpha = 0.9, size = 3.5, show.legend = T) +
  #scale_x_continuous(label=scientific_10) +
  scale_colour_manual(values = c("darkslategray", "lightblue4", "hotpink4", "indianred3", "goldenrod2", "khaki2"), name="", labels = lab2, breaks=c('30', "90", "180", "300", "600", "900")) +
  #scale_colour_discrete(type=c("seagreen4", "palegreen3", "brown1", "brown4")) +
  scale_shape_manual(values = c(15, 16, 17, 18), name="", labels = lab1) +
...
SolFitsAllPigmentTurnerDay %>% 
  filter(Ex_WL==445) %>% 
ggplot() +
  geom_point(aes(AllmeanJVPSII_aLHIIOxbomax_Corrcell_day, deltaOD_Lmu_corr, colour=as.factor(Par_ue)), alpha = 0.9, size = 3.5, show.legend = T) +
  scale_x_continuous(label=scientific_10) +
  #scale_linetype_manual(values=c("equal900" = "dotted", "less900" = "solid"), breaks=c('8', '12', '16', "24", "", "")) +
  scale_colour_manual(values = c("darkslategray", "lightblue4", "hotpink4", "indianred3", "goldenrod2", "khaki2"), name="", labels = lab2, breaks=c('30', "90", "180", "300", "600", "900")) +
  #scale_colour_discrete(type=c("seagreen4", "palegreen3", "brown1", "brown4")) +
...
SolFitsAllPigmentTurnerDay %>% 
  filter(Ex_WL==445) %>% 
ggplot() +
  geom_point(aes(AllmeanJVPSII_ETRtauav_FoSig_Corrcell_day, deltaOD_Lmu_corr, colour=as.factor(Par_ue)), alpha = 0.9, size = 3.5, show.legend = T) +
  scale_x_continuous(label=scientific_10) +
  scale_colour_manual(values = c("darkslategray", "lightblue4", "hotpink4", "indianred3", "goldenrod2", "khaki2"), name="", labels = lab2, breaks=c('30', "90", "180", "300", "600", "900")) +
  #scale_colour_discrete(type=c("seagreen4", "palegreen3", "brown1", "brown4")) +
  scale_shape_manual(values = c(15, 16, 17, 18), name="", labels = lab1) +
...
SolFitsAllPigmentTurnerDay %>% 
  filter(Ex_WL==445) %>% 
ggplot() +
  geom_point(aes(AllmeanJVPSII_ETRqpOxbo_FoSig_Corrcell_day, deltaOD_Lmu_corr, colour=as.factor(Par_ue)), alpha = 0.9, size = 3.5, show.legend = T) +
  scale_x_continuous(label=scientific_10) +
  scale_colour_manual(values = c("darkslategray", "lightblue4", "hotpink4", "indianred3", "goldenrod2", "khaki2"), name="", labels = lab2, breaks=c('30', "90", "180", "300", "600", "900")) +
  #scale_colour_discrete(type=c("seagreen4", "palegreen3", "brown1", "brown4")) +
  scale_shape_manual(values = c(15, 16, 17, 18), name="", labels = lab1) +
...
SolFitsAllPigmentTurnerDay %>% 
  filter(Ex_WL==445) %>% 
ggplot() +
  geom_point(aes(AllmeanJVPSII_ETRtauav_aLHII_Sig_Corrcell_day, deltaOD_Lmu_corr, colour=as.factor(Par_ue)), alpha = 0.9, size = 3.5, show.legend = T) +
  scale_x_continuous(label=scientific_10) +
  scale_colour_manual(values = c("darkslategray", "lightblue4", "hotpink4", "indianred3", "goldenrod2", "khaki2"), name="", labels = lab2, breaks=c('30', "90", "180", "300", "600", "900")) +
  #scale_colour_discrete(type=c("seagreen4", "palegreen3", "brown1", "brown4")) +
  scale_shape_manual(values = c(15, 16, 17, 18), name="", labels = lab1) +
...
SolFitsAllPigmentTurnerDay %>% 
  filter(Ex_WL==445) %>% 
ggplot() +
  geom_point(aes(AllmeanJVPSII_ETRqpOxbo_aLHII_Sig_Corrcell_day, deltaOD_Lmu_corr, colour=as.factor(Par_ue)), alpha = 0.9, size = 3.5, show.legend = T) +
  #scale_x_continuous(label=scientific_10) +
  scale_colour_manual(values = c("darkslategray", "lightblue4", "hotpink4", "indianred3", "goldenrod2", "khaki2"), name="", labels = lab2, breaks=c('30', "90", "180", "300", "600", "900")) +
  #scale_colour_discrete(type=c("seagreen4", "palegreen3", "brown1", "brown4")) +
  scale_shape_manual(values = c(15, 16, 17, 18), name="", labels = lab1) +
...
SolFitsAllPigmentTurnerDaySmall<-SolFitsAllPigmentTurnerDay %>% 
  ...
  mutate(AllmeanJVPSII_aLHIIOxbomax_Corrcell_day1019 = AllmeanJVPSII_aLHIIOxbomax_Corrcell_day/10000000000000000000) %>% 
  mutate(AllmeanJVPSII_ETRtauav_FoSig_Corrcell_day1019 = AllmeanJVPSII_ETRtauav_FoSig_Corrcell_day/10000000000000000000) %>% 
  mutate(AllmeanJVPSII_ETRqpOxbo_FoSig_Corrcell_day1019 = AllmeanJVPSII_ETRqpOxbo_FoSig_Corrcell_day/10000000000000000000) %>% 
  mutate(AllmeanJVPSII_ETRtauav_aLHII_Sig_Corrcell_day1019 = AllmeanJVPSII_ETRtauav_aLHII_Sig_Corrcell_day/10000000000000000000) %>% 
  mutate(AllmeanJVPSII_ETRqpOxbo_aLHII_Sig_Corrcell_day1019 = AllmeanJVPSII_ETRqpOxbo_aLHII_Sig_Corrcell_day/10000000000000000000) 
```
...
SolFitsAllPigmentTurnerDaySmall %>% 
  filter(Ex_WL==445) %>% 
ggplot() +
  geom_point(aes(AllmeanJVPSII_ETRtauav_aLHII_Sig_Corrcell_day1019, deltaOD_Lmu_corr, colour=as.factor(Par_ue)), alpha = 0.9, size = 3.5, show.legend = T) +
  #scale_x_continuous(label=scientific_10) +
  scale_colour_manual(values = c("darkslategray", "lightblue4", "hotpink4", "indianred3", "goldenrod2", "khaki2"), name="", labels = lab2, breaks=c('30', "90", "180", "300", "600", "900")) +
  #scale_colour_discrete(type=c("seagreen4", "palegreen3", "brown1", "brown4")) +
  scale_shape_manual(values = c(15, 16, 17, 18), name="", labels = lab1) +
...
SolFitsAllPigmentTurnerDayfit1 <- SolFitsAllPigmentTurnerDaySmall %>% 
  filter(Ex_WL==445) %>% 
  select(c(Strain, deltaOD_Lmu_corr, JVPSII_aLHIIOxbomax_Corrcell_day1019, Par_ue, Photoperiod)) 
JVPSII_aLHIIOxbomaxfit <- SolFitsAllPigmentTurnerDayfit1 %>%
  nest(data = -c("Strain")) %>%  
  mutate(GRCplatt_Model = map(data, ~nlsLM(deltaOD_Lmu_corr ~ grcplatt(I = JVPSII_aLHIIOxbomax_Corrcell_day1019, a, b, Pmax), data = .x, start = list(a =0.01/1, b = 1/5, Pmax = 5), lower = c(0, 0, 0)))) %>%    
...
SolFitsAllPigmentTurnerDayfit2 <- SolFitsAllPigmentTurnerDaySmall %>% 
  filter(Ex_WL==445) %>% 
  select(c(Strain, deltaOD_Lmu_corr, JVPSII_ETRtauav_FoSig_Corrcell_day1019, Par_ue, Photoperiod)) 
JVPSII_ETRtauav_FoSigfit <- SolFitsAllPigmentTurnerDayfit2 %>%
  nest(data = -c("Strain")) %>%  
  mutate(GRCplatt_Model = map(data, ~nlsLM(deltaOD_Lmu_corr ~ grcplatt(I = JVPSII_ETRtauav_FoSig_Corrcell_day1019, a, b, Pmax), data = .x, start = list(a =0.01/1, b = 1/5, Pmax = 5), lower = c(0, 0, 0)))) %>%    
  mutate(GRCplatt_Param = map(GRCplatt_Model, tidy),          
         GRCplatt_Predict = map(GRCplatt_Model, possibly(augment)),          
         GRCplatt_Glance = map(GRCplatt_Model, possibly(glance)))
...
JVPSII_ETRqpOxbo_FoSigfit <- SolFitsAllPigmentTurnerDayfit3 %>%
  nest(data = -c("Strain")) %>%  
  mutate(GRCplatt_Model = map(data, ~nlsLM(deltaOD_Lmu_corr ~ grcplatt(I = JVPSII_ETRqpOxbo_FoSig_Corrcell_day1019, a, b, Pmax), data = .x, start = list(a =0.01/1, b = 1/5, Pmax = 5), lower = c(0, 0, 0)))) %>%    
  mutate(GRCplatt_Param = map(GRCplatt_Model, tidy),          
         GRCplatt_Predict = map(GRCplatt_Model, possibly(augment)),          
         GRCplatt_Glance = map(GRCplatt_Model, possibly(glance)))
...
SolFitsAllPigmentTurnerDayfit4 <- SolFitsAllPigmentTurnerDaySmall %>% 
  filter(Ex_WL==445) %>% 
  select(c(Strain, deltaOD_Lmu_corr, JVPSII_ETRtauav_aLHII_Sig_Corrcell_day1019, Par_ue, Photoperiod)) 
JVPSII_ETRtauav_aLHII_Sigfit <- SolFitsAllPigmentTurnerDayfit4 %>%
  nest(data = -c("Strain")) %>%  
  mutate(GRCplatt_Model = map(data, ~nlsLM(deltaOD_Lmu_corr ~ grcplatt(I = JVPSII_ETRtauav_aLHII_Sig_Corrcell_day1019, a, b, Pmax), data = .x, start = list(a =0.01/1, b = 1/5, Pmax = 5), lower = c(0, 0, 0)))) %>%    
  mutate(GRCplatt_Param = map(GRCplatt_Model, tidy),          
         GRCplatt_Predict = map(GRCplatt_Model, possibly(augment)),          
         GRCplatt_Glance = map(GRCplatt_Model, possibly(glance)))
...
SolFitsAllPigmentTurnerDayfit5 <- SolFitsAllPigmentTurnerDaySmall %>% 
  filter(Ex_WL==445) %>% 
  select(c(Strain, deltaOD_Lmu_corr, JVPSII_ETRqpOxbo_aLHII_Sig_Corrcell_day1019, Par_ue, Photoperiod)) 
JVPSII_ETRqpOxbo_aLHII_Sigfit <- SolFitsAllPigmentTurnerDayfit5 %>%
  nest(data = -c("Strain")) %>%  
  mutate(GRCplatt_Model = map(data, ~nlsLM(deltaOD_Lmu_corr ~ grcplatt(I = JVPSII_ETRqpOxbo_aLHII_Sig_Corrcell_day1019, a, b, Pmax), data = .x, start = list(a =0.01/1, b = 1/5, Pmax = 5), lower = c(0, 0, 0)))) %>%    
  mutate(GRCplatt_Param = map(GRCplatt_Model, tidy),          
         GRCplatt_Predict = map(GRCplatt_Model, possibly(augment)),          
         GRCplatt_Glance = map(GRCplatt_Model, possibly(glance)))
...
ggplot(SolFitsAllPigmentTurnerDaySmall445, aes(JVPSII_aLHIIOxbomax_Corrcell_day1019, deltaOD_Lmu_corr)) +
  geom_point(aes(x=JVPSII_aLHIIOxbomax_Corrcell_day1019, y=deltaOD_Lmu_corr, colour=as.factor(Par_ue)), alpha = 0.9, size = 3.5, show.legend = T) +
...
ggplot(SolFitsAllPigmentTurnerDaySmall445, aes(JVPSII_ETRtauav_FoSig_Corrcell_day1019, deltaOD_Lmu_corr)) +
  geom_point(aes(x=JVPSII_ETRtauav_FoSig_Corrcell_day1019, y=deltaOD_Lmu_corr, colour=as.factor(Par_ue)), alpha = 0.9, size = 3.5, show.legend = T) +
...
ggplot(SolFitsAllPigmentTurnerDaySmall445, aes(JVPSII_ETRqpOxbo_FoSig_Corrcell_day1019, deltaOD_Lmu_corr)) +
...
ggplot(SolFitsAllPigmentTurnerDaySmall445, aes(AllmeanJVPSII_ETRtauav_aLHII_Sig_Corrcell_day1019, deltaOD_Lmu_corr)) +
  geom_point(aes(x=AllmeanJVPSII_ETRtauav_aLHII_Sig_Corrcell_day1019, y=deltaOD_Lmu_corr, colour=as.factor(Par_ue)), alpha = 0.9, size = 3.5, show.legend = T) +
...
ggplot(SolFitsAllPigmentTurnerDaySmall445, aes(JVPSII_ETRqpOxbo_aLHII_Sig_Corrcell_day1019, deltaOD_Lmu_corr)) +
  geom_point(aes(x=JVPSII_ETRqpOxbo_aLHII_Sig_Corrcell_day1019, y=deltaOD_Lmu_corr, colour=as.factor(Par_ue)), alpha = 0.9, size = 3.5, show.legend = T) +
