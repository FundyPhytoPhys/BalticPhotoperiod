...
```{r read ProcessFile}
GrowthRateFile <- "../Data/ProcessedData/ProcessedGrowthRateData/BalticPhotoperiod_Processed_GrowthRate.Rds"
...
```{r read ProcessFile}
SolisenseFile <- "../Data/ProcessedData/ProcessedSolisenseData/BalticPhotoperiod_Processed_SolisensePigmentsExp.Rds"
...
GrowthRateSoliExp %>% 
  ggplot() +
  geom_point(aes(x = PhycoChlaRatioExp, y = Sig_nm2psii, colour = as.factor(Par_ue), shape = as.factor(Photoperiod)), size = 3.5, show.legend = T) +
