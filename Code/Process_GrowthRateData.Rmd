...
```{r save plot}
ggsave(file = file.path(FigPath, paste("SFig_GrowthRate",".png",sep = "")), height=10, width= 8,  dpi = 300, limitsize = TRUE)
```
...
```{r save plot}
ggsave(file = file.path(FigPath, paste("Fig_GrowthRate",".png",sep = "")), height=10, width= 8,  dpi = 300, limitsize = TRUE)
```
...
```{r}
saveRDS(AnovaTest_GrowthRateModel_Light, file.path(TableRdsPath, paste(Project, "AnovaModel_GrowthRate_Light.Rds", sep = "_"), fsep = .Platform$file.sep), ascii = FALSE, version = NULL, compress = "xz", refhook = NULL)

saveRDS(AnovaTest_GrowthRateModel_Photoperiod, file.path(TableRdsPath, paste(Project, "AnovaModel_GrowthRate_Photoperiod.Rds", sep = "_"), fsep = .Platform$file.sep), ascii = FALSE, version = NULL, compress = "xz", refhook = NULL)
