...
```{r save plot}
ggsave(file = file.path(FigPath, paste("SFig_GrowthRate_Light",".png",sep = "")), height=10, width= 8,  dpi = 300, limitsize = TRUE)
```
...
```{r save plot}
ggsave(file = file.path(FigPath, paste("Fig_GrowthRate_Photoperiod",".png",sep = "")), height=10, width= 8,  dpi = 300, limitsize = TRUE)
```
