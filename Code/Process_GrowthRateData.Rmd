...
MCGrowthRateStats<-rbind(MCGrowthRate, MCGrowthRate)
  #filter(Par_ue != 600) 
...
```{r read imported Olis file}
PigmentAllFile <- "../Data/ProcessedData/ProcessedPigmentsData/BalticPhotoperiod_Processed_PigmentAll.Rds"
...
```{r}
rm(tMaxAGLines_056, tMaxAGLines_077, tMaxAGLines_048, tMaxAGLines_127, tmaxAG, PigmentExp)
```
...
MCGrowthRateExpSP<-MCGrowthRateAll %>% 
...
# Create preliminary plot - per Par_ue
...
# Create preliminary plot - per photoperiod
...
```{r}
saveRDS(AnovaTest_GrowthRateFitParam_Light, file.path(RDSTablePath, paste(Project, "AnovaTest_GrowthRateFitParam_Light.Rds", sep = "_"), fsep = .Platform$file.sep), ascii = FALSE, version = NULL, compress = "xz", refhook = NULL)

saveRDS(TukeyHSDTest_GrowthRateFitParam_Light, file.path(RDSTablePath, paste(Project, "TukeyHSDTest_GrowthRateFitParam_Light.Rds", sep = "_"), fsep = .Platform$file.sep), ascii = FALSE, version = NULL, compress = "xz", refhook = NULL)

saveRDS(AnovaTest_GrowthRateFitParam_Photoperiod, file.path(RDSTablePath, paste(Project, "AnovaTest_GrowthRateFitParam_Photoperiod.Rds", sep = "_"), fsep = .Platform$file.sep), ascii = FALSE, version = NULL, compress = "xz", refhook = NULL)

saveRDS(TukeyHSDTest_GrowthRateFitParam_Photoperiod, file.path(RDSTablePath, paste(Project, "TukeyHSDTest_GrowthRateFitParam_Photoperiod.Rds", sep = "_"), fsep = .Platform$file.sep), ascii = FALSE, version = NULL, compress = "xz", refhook = NULL)
```
...
```{r save plot}
ggsave(file = file.path(PlotsPath, paste("GrowthRateLight_Plot",".png",sep = "")), height=10, width= 8,  dpi = 300, limitsize = TRUE)
```
...
```{r save plot}
ggsave(file = file.path(PlotsPath, paste("GrowthRatePhotoperiod_Plot",".png",sep = "")), height=10, width= 8,  dpi = 300, limitsize = TRUE)
```
...
```{r}
saveRDS(AnovaTest_GrowthRateModel_Light, file.path(RDSTablePath, paste(Project, "GrowthRateAnovaModel_Light.Rds", sep = "_"), fsep = .Platform$file.sep), ascii = FALSE, version = NULL, compress = "xz", refhook = NULL)

saveRDS(AnovaTest_GrowthRateModel_Photoperiod, file.path(RDSTablePath, paste(Project, "GrowthRateAnovaModel_Photoperiod.Rds", sep = "_"), fsep = .Platform$file.sep), ascii = FALSE, version = NULL, compress = "xz", refhook = NULL)

saveRDS(MCParamAll_Light, file.path(RDSTablePath, paste(Project, "GrowthRate_FitParam_Light.Rds", sep = "_"), fsep = .Platform$file.sep), ascii = FALSE, version = NULL, compress = "xz", refhook = NULL)

saveRDS(MCParamAll_Photoperiod, file.path(RDSTablePath, paste(Project, "GrowthRate_FitParam_Photoperiod.Rds", sep = "_"), fsep = .Platform$file.sep), ascii = FALSE, version = NULL, compress = "xz", refhook = NULL)
```
...
```{r}
# rm(GRCplatt_PredictGrowthPC, GRCplatt_PredictGrowthPE30, GRCplatt_PredictGrowthPE90900, MCGrowthSP, MCModelAll, AnovaModel_GrowthRate, AnovaModel_GrowthRate2, MCParamAll, model)
```
