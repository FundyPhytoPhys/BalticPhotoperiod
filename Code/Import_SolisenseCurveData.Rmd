---
title: "Import_SolisenseCurveData"
author:
...
# DataOut <- file.path("..", "Data", "ImportedData", "ImportedSolisenseCurveData")
# 
...
## Read Data
```{r data files}
# MCFiles <- list.files(path = file.path("..", "Data", "RawData", "SolisenseCurveData"), full.names = TRUE)
# MCFiles
```
...
zip_file <- file.path("..", "Data", "RawData", "SolisenseCurveData.zip")
