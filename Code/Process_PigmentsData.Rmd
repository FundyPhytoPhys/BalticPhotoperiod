...
```{r create Sigma plot, fig.height = 8, fig.width = 8, warning = FALSE}
data_text_y0Exp<- data.frame(WL = c("WW", "WW"), Phase = c("Exponential"), O2=c(21, 21, 21, 21), Strain  = c("PC-rich_056", "PC-rich_077", "PE-rich_048", "PE-rich_127"),  label = c('y[0]~"="~0.5', 'y[0]~"="~0.5', 'y[0]~"="~1.0', 'y[0]~"="~0.9'))
data_text_yfExp<- data.frame(WL = c("WW", "WW"), Phase = c("Exponential"), O2=c(21, 21, 21, 21), Strain  = c("PC-rich_056", "PC-rich_077", "PE-rich_048", "PE-rich_127"),  label = c('y[f]~"="~0.3', 'y[f]~"="~0.4', 'y[f]~"="~0.5', 'y[f]~"="~0.5'))
...
data_text_y0St<- data.frame(WL = c("WW", "WW"), Phase = c("Pre-stationary"), O2=c(21, 21, 21, 21), Strain  = c("PC-rich_056", "PC-rich_077", "PE-rich_048", "PE-rich_127"),  label = c('y[0]~"="~0.4', 'y[0]~"="~2.6', 'y[0]~"="~0.5', 'y[0]~"="~5.1'))
data_text_yfSt<- data.frame(WL = c("WW", "WW"), Phase = c("Pre-stationary"), O2=c(21, 21, 21, 21), Strain  = c("PC-rich_056", "PC-rich_077", "PE-rich_048", "PE-rich_127"),  label = c('y[f]~"="~0.4', 'y[f]~"="~0.4', 'y[f]~"="~0.0', 'y[f]~"="~0.5'))
