...
GrowthCurveData from Baltic_Photoperiod_Processed_GrowthCurve.Rds, 
and OlisJazData from Baltic_Photoperiod_Processed_OlisSpectraAll.Rds
...
The tables with the compiled correlations were saved in the Baltic_Photoperiod\Output\TablesRDS folder as:
Baltic_Photoperiod_Table_GrowthCorrelation.Rds,
Baltic_Photoperiod_Table_PigmentsCorrelation.Rds
...
```{r}
data_textPaersonBA56G_720 <- data.frame(Equation = c('N/mL = (OD720*218497)+34902'), Strain = c("PC-rich_056"), OD = c("720"), R2 = c("0.6167"), R = c("0.79"), p = c("< 2.2e-16 ***"))
data_textPaersonBA77G_720 <- data.frame(Equation = c('N/mL = (OD720*264482)+38766'), Strain = c("PC-rich_077"), OD = c("720"), R2 = c("0.8278"), R = c("0.91"), p = c("< 2.2e-16 ***"))
data_textPaersonBA48R_720 <- data.frame(Equation = c('N/mL = (OD720*600583)+14873'), Strain = c("PE-rich_048"), OD = c("720"), R2 = c("0.9173"), R = c("0.96"), p = c("< 2.2e-16 ***"))
data_textPaersonBA127R_720 <- data.frame(Equation = c('N/mL = (OD720*803505)+2786'), Strain = c("PE-rich_127"), OD = c("720"), R2 = c("0.8790"), R = c("0.94"), p = c("< 1.6e-15 ***"))
...
```{r}
data_textPaersonBA56G_680 <- data.frame(Equation = c('N/mL = (OD680*160489)+34573'), Strain = c("PC-rich_056"), OD = c("680"), R2 = c("0.6395"), R = c("0.80"), p = c("< 2.2e-16 ***"))
data_textPaersonBA77G_680 <- data.frame(Equation = c('N/mL = (OD680*204581)+38483'), Strain = c("PC-rich_077"), OD = c("680"), R2 = c("0.8314"), R = c("0.91"), p = c("< 2.2e-16 ***"))
data_textPaersonBA48R_680 <- data.frame(Equation = c('N/mL = (OD680*450190)+14516'), Strain = c("PE-rich_048"), OD = c("680"), R2 = c("0.9168"), R = c("0.96"), p = c("< 2.2e-16 ***"))
data_textPaersonBA127R_680 <- data.frame(Equation = c('N/mL = (OD680*614649)+1446'), Strain = c("PE-rich_127"), OD = c("680"), R2 = c("0.8846"), R = c("0.94"), p = c("< 8e-16 ***"))
...
```{r save rds}
saveRDS(GrowthCorrelation, file.path(RDSTablePath, paste(Project, "Table_GrowthCorrelation.Rds", sep = "_"), fsep = .Platform$file.sep), ascii = FALSE, version = NULL, compress = "xz", refhook = NULL)
```
...
```{r}
data_textPaersonChla <- data.frame(Equation = c('Chla µg/mL = (Abs665*13.411029)+0.154793'), Pigment = c("Chl a"), OD = c("665"), R2 = c("0.8654"), R = c("0.93"), p = c("< 2.2e-16 ***"))
data_textPaersonCar <- data.frame(Equation = c('Car µg/mL = (Abs480*5.469880)+0.089971'), Pigment = c("Car"), OD = c("480"), R2 = c("0.7913"), R = c("0.89"), p = c("< 2.2e-16 ***"))
data_textPaersonPE <- data.frame(Equation = c('PE µg/mL = (Abs565*26.760737)-0.143872'), Pigment = c("PE"), OD = c("565"), R2 = c("0.6979"), R = c("0.84"), p = c("< 2.2e-16 ***"))
data_textPaersonPC <- data.frame(Equation = c('PC µg/mL = (Abs620*29.979866)-0.182611'), Pigment = c("PC"), OD = c("620"), R2 = c("0.8073"), R = c("0.90"), p = c("< 2.2e-16 ***"))
data_textPaersonAPC <- data.frame(Equation = c('APC µg/mL = (Abs650*3.873803)+0.021964'), Pigment = c("APC"), OD = c("650"), R2 = c("0.08721"), R = c("0.3"), p = c("< 2.8e-06 ***"))
...
ClarioPigmentChla %>% 
  ...
  geom_text(data=data_textPaersonChla, aes(x=0.06, y=8, label=Equation), size=4) +
  geom_smooth(method=lm, se=FALSE, colour = "gray22") +
  stat_cor(method="pearson") +
...
ClarioPigmentCar %>% 
  ...
  geom_text(data=data_textPaersonCar, aes(x=0.06, y=8, label=Equation), size=4) +
  geom_smooth(method=lm, se=FALSE, colour = "gray22") +
  stat_cor(method="pearson") +
...
ClarioPigmentPE %>% 
  ...
  geom_text(data=data_textPaersonPE, aes(x=0.06, y=8, label=Equation), size=4) +
  geom_smooth(method=lm, se=FALSE, colour = "gray22") +
  stat_cor(method="pearson") +
...
ClarioPigmentPC %>% 
  ...
  geom_text(data=data_textPaersonPC, aes(x=0.06, y=8, label=Equation), size=4) +
  geom_smooth(method=lm, se=FALSE, colour = "gray22") +
  stat_cor(method="pearson") +
...
ClarioPigmentAPC %>% 
  ...
  geom_text(data=data_textPaersonAPC, aes(x=0.06, y=8, label=Equation), size=4) +
  geom_smooth(method=lm, se=FALSE, colour = "gray22") +
  stat_cor(method="pearson") +
...
```{r save rds}
saveRDS(PigmentsCorrelation, file.path(RDSTablePath, paste(Project, "Table_PigmentsCorrelation.Rds", sep = "_"), fsep = .Platform$file.sep), ascii = FALSE, version = NULL, compress = "xz", refhook = NULL)
```
...
MC_cellmLPigment <- MC_cellmL %>%
  left_join(., PigmentsClarioOlisCorr, by = c("SampleID"="SampleID", "Run" = "Run", "Strain" = "Strain", "ExpDate" = "ExpDate", "Par_ue" = "Par_ue", "Photoperiod" = "Photoperiod", "Tube" = "Tube", "O2" = "O2", "WL" = "WL", "LightShape" = "LightShape", "ExpEndDate"="ExpEndDate","E_days" = "E_days")) 
```
...
```{r save rds}
saveRDS(MC_cellmLPigment, file.path(DataOut, paste(Project, "Imported_PigmentData.Rds", sep = "_"), fsep = .Platform$file.sep), ascii = FALSE, version = NULL, compress = "xz", refhook = NULL)
```
