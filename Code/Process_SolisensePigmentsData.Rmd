...
data_text_AnovaPhase<- data.frame(WL = c("WW", "WW"), Phase = c("Exponential"), O2=c(21, 21, 21, 21), Strain  = c("PC-rich_056", "PC-rich_077", "PE-rich_048", "PE-rich_127"),  label = c('Welch’s t-test, \u03B1 = 0.05', 'Welch’s t-test, \u03B1 = 0.05', 'Welch’s t-test, \u03B1 = 0.05', 'Welch’s t-test, \u03B1 = 0.05'))
...
ggplot(SolFitsExpFitAll590, aes(x = PARPhotonDose_day, y = Sig_nm2psii)) +
  ...
  geom_text(data=data_text_AnovaPhase, aes(x=26000000, y=-0.8, label=label), colour = "blue", size=4) +
...
ggplot(PhycoChlaRatioChoosenPUR, aes(x = PARPhotonDose_day, y = PURPARRatio)) +
  ...
  geom_text(data=data_text_AnovaPhase, aes(x=26000000, y=-0.04, label=label), colour = "blue", size=4) +
