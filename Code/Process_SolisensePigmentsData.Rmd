...
SolFitsAllPigmentPCPE590 %>% 
  ...
  geom_text(data=data_text_AnovaSt48, aes(x=3.0, y=7.5, label=label), colour = "blue", size=4) +
  geom_text(data=data_text_AnovaSt127, aes(x=3.0, y=7, label=label), colour = "blue", size=4) +
  ...
  geom_text(data=data_text_AnovaSt48P, aes(x=3.0, y=2.5, label=label), colour = "blue", size=4) +
  geom_text(data=data_text_AnovaSt127P, aes(x=3.0, y=3, label=label), colour = "blue", size=4) +
...
data_text_AnovaSt56<- data.frame(facetsPhase = c("Phase~of~growth"), Phase = c("Pre-stationary"), facetsStrain = c("Strain"), Strain  = c("PC-rich_056"), label = c('a'))
data_text_AnovaSt77<- data.frame(facetsPhase = c("Phase~of~growth"), Phase = c("Pre-stationary"), facetsStrain = c("Strain"), Strain  = c("PC-rich_077"), label = c("b"))
data_text_AnovaSt48<- data.frame(facetsPhase = c("Phase~of~growth"), Phase = c("Pre-stationary"), facetsStrain = c("Strain"), Strain  = c("PE-rich_048"), label = c("c"))
data_text_AnovaSt127<- data.frame(facetsPhase = c("Phase~of~growth"), Phase = c("Pre-stationary"), facetsStrain = c("Strain"), Strain  = c("PE-rich_127"), label = c("ad"))
...
SolFitsAllPigmentPCPE590dark %>% 
  ...
  geom_text(data=data_text_AnovaSt48, aes(x=3.0, y=6.5, label=label), colour = "blue", size=4) +
  geom_text(data=data_text_AnovaSt127, aes(x=3.1, y=6, label=label), colour = "blue", size=4) +
  ...
  geom_text(data=data_text_AnovaSt48P, aes(x=3.0, y=2.5, label=label), colour = "blue", size=4) +
  geom_text(data=data_text_AnovaSt127P, aes(x=3.1, y=2.5, label=label), colour = "blue", size=4) +
...
```{r save plot}
ggsave(file = file.path(FigPath, paste("SFig_SigmaPig590dark",".png",sep = "")), height=10, width= 8,  dpi = 300, limitsize = TRUE)
```
...
```{r save rds}
saveRDS(SolFitsAllPigmentPCPETurner, file.path(DataOut, paste(Project, "Processed_SolisensePigmentsData.Rds", sep = "_"), fsep = .Platform$file.sep), ascii = FALSE, version = NULL, compress = "xz", refhook = NULL)
```
