...
#   drop_na(Sig_nm2psii, PhycoChlaRatio) %>% 
#   #filter(Phase=="Exponential") %>%
#   filter(Strain == "PC-rich_056") %>% 
#   select(c(Sig_nm2psii, PhycoChlaRatio, Phase)) 
...
#   select(c(Sig_nm2psii, PhycoChlaRatio, Phase)) 
#   
# model1 <- glm(Sig_nm2psii~PhycoChlaRatio+Phase, data = SolFitsBA56Exp)
# model2 <- glm(Sig_nm2psii~PhycoChlaRatio+Phase, data = SolFitsBA77Exp$model) 
#   ANOVAdupa<-anova(model1, model2)
# 
# 
# Sig590Stats<-fitted_Param590
# Sig590Stats2<-rbind(Sig590Stats, Sig590Stats)
