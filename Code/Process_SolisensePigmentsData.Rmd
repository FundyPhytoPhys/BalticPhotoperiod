...
ASolPig590<-SolFitsAllPigmentPCPE590 %>% 
  ggplot() +
...
```{r save plot}
ggsave(file = file.path(FigPath, paste("Sig_newIdea2",".png",sep = "")), height=9, width= 12,  dpi = 300, limitsize = TRUE)
```
