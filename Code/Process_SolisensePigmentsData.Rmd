...
data_text_AnovaPhase<- data.frame(WL = c("WW", "WW"), Phase = c("Exponential"), O2=c(21, 21, 21, 21), Strain  = c("PC-rich_056", "PC-rich_077", "PE-rich_048", "PE-rich_127"),  label = c('ANOVA, p < 0.05', 'ANOVA, p < 0.05', 'ANOVA, p < 0.05', 'ANOVA, p < 0.05'))
...
ggplot(SolFitsExpFitAll590, aes(x = PARPhotonDose_day, y = Sig_nm2psii)) +
  ...
  geom_text(data=data_text_AnovaExp56, aes(x=15000000, y=5, label=label), colour = "blue", size=4) +
  geom_text(data=data_text_AnovaExp77, aes(x=15000000, y=5, label=label), colour = "blue", size=4) +
  geom_text(data=data_text_AnovaExp48, aes(x=15000000, y=5, label=label), colour = "blue", size=4) +
  geom_text(data=data_text_AnovaExp127, aes(x=15000000, y=5, label=label), colour = "blue", size=4) +
    
  geom_text(data=data_text_AnovaSt56, aes(x=15000000, y=5, label=label), colour = "blue", size=4) +
  geom_text(data=data_text_AnovaSt77, aes(x=15000000, y=5, label=label), colour = "blue", size=4) +
  geom_text(data=data_text_AnovaSt48, aes(x=15000000, y=58, label=label), colour = "blue", size=4) +
  geom_text(data=data_text_AnovaSt127, aes(x=15000000, y=5, label=label), colour = "blue", size=4) +
    
  geom_text(data=data_text_AnovaPhase, aes(x=15000000, y=-0.1, label=label), colour = "blue", size=4) +
  ...
  coord_cartesian(xlim = c(0, 82000000), ylim = c(-0.5, 12)) +
...
ggplot(SolFitsExpFitAll445, aes(x = PARPhotonDose_day, y = Sig_nm2psii)) +
  ...
  geom_text(data=data_text_AnovaExp, aes(x=15000000, y=-0.4, label=label), colour = "blue", size=3.5) +
  geom_text(data=data_text_AnovaSt, aes(x=15000000, y=-0.4, label=label), colour = "blue", size=3.5) +
  geom_text(data=data_text_AnovaPhase, aes(x=65000000, y=-0.4, label=label), colour = "blue", size=3.5) +
  ...
  scale_x_continuous(breaks=seq(0, 60000000, by = 30000000), label=scientific_10) +
  scale_y_continuous(breaks=seq(0, 10, by = 2)) +
  coord_cartesian(xlim = c(0, 80000000), ylim = c(-1, 10)) +
  ggh4x::facet_nested(rows = vars(O2, Strain), cols = vars(WL, Phase), labeller = labeller(WL = WL.labs, O2 = O2.labs)) +
  theme_bw() +
  theme(panel.grid.minor = element_blank(),
        panel.grid.major = element_blank(),
...
ggplot(PhycoChlaRatioChoosenPUR, aes(x = PARPhotonDose_day, y = PURPARRatio)) +
  ...
  geom_text(data=data_text_y0Exp, aes(x=70000000, y=1.1, label=label), size=3.5) +
  geom_text(data=data_text_yfExp, aes(x=70000000, y=0.9, label=label), size=3.5) +
  geom_text(data=data_text_lambdaExp, aes(x=70000000, y=0.7, label=label), size=3.5) +

  geom_text(data=data_text_y0St, aes(x=7500000, y=1.1, label=label), size=3.5) +
  geom_text(data=data_text_yfSt, aes(x=7500000, y=0.9, label=label), size=3.5) +
  geom_text(data=data_text_lambdaSt, aes(x=7500000, y=0.7, label=label), size=3.5) +

  geom_text(data=data_text_AnovaExp, aes(x=15000000, y=0.05, label=label), colour = "blue", size=3.5) +
  geom_text(data=data_text_AnovaSt, aes(x=15000000, y=0.05, label=label), colour = "blue", size=3.5) +
...
Stats56_77Exp<-SolFitsAllPigmentPCPE %>%
  ...
  filter(Strain == "PC-rich_056" | Strain == "PC-rich_077") %>% 
  select(c(Strain, Sig_nm2psii, AllmeanPhycoChlaRatio))
model_56_77Exp<-summary(lm(Sig_nm2psii ~ AllmeanPhycoChlaRatio + Strain + AllmeanPhycoChlaRatio:Strain,data=Stats56_77Exp))
...
SolFits56_48Exp<-SolFitsAllPigmentPCPE %>%
  ...
  filter(Strain == "PC-rich_056" | Strain == "PE-rich_048") %>% 
  select(c(Strain, Sig_nm2psii, AllmeanPhycoChlaRatio))
model_56_48Exp<-summary(lm(Sig_nm2psii ~ AllmeanPhycoChlaRatio + Strain + AllmeanPhycoChlaRatio:Strain,data=SolFits56_48Exp))
...
SolFits56_127Exp<-SolFitsAllPigmentPCPE %>%
  ...
  filter(Strain == "PC-rich_056" | Strain == "PE-rich_127") %>% 
  select(c(Strain, Sig_nm2psii, AllmeanPhycoChlaRatio))
model_56_127Exp<-summary(lm(Sig_nm2psii ~ AllmeanPhycoChlaRatio + Strain + AllmeanPhycoChlaRatio:Strain,data=SolFits56_127Exp))
...
SolFits48_127Exp<-SolFitsAllPigmentPCPE %>%
  ...
  filter(Strain == "PE-rich_048" | Strain == "PE-rich_127") %>% 
  select(c(Strain, Sig_nm2psii, AllmeanPhycoChlaRatio))
model_48_127Exp<-summary(lm(Sig_nm2psii ~ AllmeanPhycoChlaRatio + Strain + AllmeanPhycoChlaRatio:Strain,data=SolFits48_127Exp))
...
SolFits77_48Exp<-SolFitsAllPigmentPCPE %>%
  ...
  filter(Strain == "PC-rich_077" | Strain == "PE-rich_048") %>% 
  select(c(Strain, Sig_nm2psii, AllmeanPhycoChlaRatio))
model_77_48Exp<-summary(lm(Sig_nm2psii ~ AllmeanPhycoChlaRatio + Strain + AllmeanPhycoChlaRatio:Strain,data=SolFits77_48Exp))
...
SolFits77_127Exp<-SolFitsAllPigmentPCPE %>%
  ...
  filter(Strain == "PC-rich_077" | Strain == "PE-rich_127") %>% 
  select(c(Strain, Sig_nm2psii, AllmeanPhycoChlaRatio))
model_77_127Exp<-summary(lm(Sig_nm2psii ~ AllmeanPhycoChlaRatio + Strain + AllmeanPhycoChlaRatio:Strain,data=SolFits77_127Exp))
...
Stats56_77St<-SolFitsAllPigmentPCPE %>%
  ...
  filter(Strain == "PC-rich_056" | Strain == "PC-rich_077") %>% 
  select(c(Strain, Sig_nm2psii, AllmeanPhycoChlaRatio))
model_56_77St<-summary(lm(Sig_nm2psii ~ AllmeanPhycoChlaRatio + Strain + AllmeanPhycoChlaRatio:Strain,data=Stats56_77St))
...
SolFits56_48St<-SolFitsAllPigmentPCPE %>%
  ...
  filter(Strain == "PC-rich_056" | Strain == "PE-rich_048") %>% 
  select(c(Strain, Sig_nm2psii, AllmeanPhycoChlaRatio))
model_56_48St<-summary(lm(Sig_nm2psii ~ AllmeanPhycoChlaRatio + Strain + AllmeanPhycoChlaRatio:Strain,data=SolFits56_48St))
...
SolFits56_127St<-SolFitsAllPigmentPCPE %>%
  ...
  filter(Strain == "PC-rich_056" | Strain == "PE-rich_127") %>% 
  select(c(Strain, Sig_nm2psii, AllmeanPhycoChlaRatio))
model_56_127St<-summary(lm(Sig_nm2psii ~ AllmeanPhycoChlaRatio + Strain + AllmeanPhycoChlaRatio:Strain,data=SolFits56_127St))
...
SolFits48_127St<-SolFitsAllPigmentPCPE %>%
  ...
  filter(Strain == "PE-rich_048" | Strain == "PE-rich_127") %>% 
  select(c(Strain, Sig_nm2psii, AllmeanPhycoChlaRatio))
model_48_127St<-summary(lm(Sig_nm2psii ~ AllmeanPhycoChlaRatio + Strain + AllmeanPhycoChlaRatio:Strain,data=SolFits48_127St))
...
SolFits77_48St<-SolFitsAllPigmentPCPE %>%
  ...
  filter(Strain == "PC-rich_077" | Strain == "PE-rich_048") %>% 
  select(c(Strain, Sig_nm2psii, AllmeanPhycoChlaRatio))
model_77_48St<-summary(lm(Sig_nm2psii ~ AllmeanPhycoChlaRatio + Strain + AllmeanPhycoChlaRatio:Strain,data=SolFits77_48St))
...
SolFits77_127St<-SolFitsAllPigmentPCPE %>%
  ...
  filter(Strain == "PC-rich_077" | Strain == "PE-rich_127") %>% 
  select(c(Strain, Sig_nm2psii, AllmeanPhycoChlaRatio))
model_77_127St<-summary(lm(Sig_nm2psii ~ AllmeanPhycoChlaRatio + Strain + AllmeanPhycoChlaRatio:Strain,data=SolFits77_127St))
...
SolFitsAllPigmentPCPE590 %>% 
  ...
  geom_text(data=data_text_AnovaExp, aes(x=1, y=-0.5, label=label), colour = "blue", size=3.5) +
  geom_text(data=data_text_AnovaSt, aes(x=1, y=-0.5, label=label), colour = "blue", size=3.5) +
