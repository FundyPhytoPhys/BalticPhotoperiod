...
model_56_77Exp<-summary(lm(Sig_nm2psii ~ PARPhotonDose_day + Strain + PARPhotonDose_day:Strain,data=Stats56_77Exp))
...
SolFits56_48Exp<-SolFitsExpFitAll %>%
  ...
  select(c(Strain, Sig_nm2psii, PARPhotonDose_day))
model_56_48Exp<-summary(lm(Sig_nm2psii ~ PARPhotonDose_day + Strain + PARPhotonDose_day:Strain,data=SolFits56_48Exp))
...
SolFits56_127Exp<-SolFitsExpFitAll %>%
  ...
  select(c(Strain, Sig_nm2psii, PARPhotonDose_day))
model_56_127Exp<-summary(lm(Sig_nm2psii ~ PARPhotonDose_day + Strain + PARPhotonDose_day:Strain,data=SolFits56_127Exp))
...
SolFits48_127Exp<-SolFitsExpFitAll %>%
  ...
  filter(Strain == "PE-rich_048" | Strain == "PE-rich_127") %>% 
  select(c(Strain, Sig_nm2psii, PARPhotonDose_day))
model_48_127Exp<-summary(lm(Sig_nm2psii ~ PARPhotonDose_day + Strain + PARPhotonDose_day:Strain,data=SolFits48_127Exp))
...
SolFits77_48Exp<-SolFitsExpFitAll %>%
  ...
  select(c(Strain, Sig_nm2psii, PARPhotonDose_day))
model_77_48Exp<-summary(lm(Sig_nm2psii ~ PARPhotonDose_day + Strain + PARPhotonDose_day:Strain,data=SolFits77_48Exp))
...
SolFits77_127Exp<-SolFitsExpFitAll %>%
  ...
  select(c(Strain, Sig_nm2psii, PARPhotonDose_day))
model_77_127Exp<-summary(lm(Sig_nm2psii ~ PARPhotonDose_day + Strain + PARPhotonDose_day:Strain,data=SolFits77_127Exp))
...
Stats56_77St<-SolFitsExpFitAll %>%
  ...
  filter(Strain == "PC-rich_056" | Strain == "PC-rich_077") %>% 
  select(c(Strain, Sig_nm2psii, PARPhotonDose_day))
model_56_77St<-summary(lm(Sig_nm2psii ~ PARPhotonDose_day + Strain + PARPhotonDose_day:Strain,data=Stats56_77St))
...
SolFits56_48St<-SolFitsExpFitAll %>%
  ...
  filter(Strain == "PC-rich_056" | Strain == "PE-rich_048") %>% 
  select(c(Strain, Sig_nm2psii, PARPhotonDose_day))
model_56_48St<-summary(lm(Sig_nm2psii ~ PARPhotonDose_day + Strain + PARPhotonDose_day:Strain,data=SolFits56_48St))
...
SolFits56_127St<-SolFitsExpFitAll %>%
  ...
  filter(Strain == "PC-rich_056" | Strain == "PE-rich_127") %>% 
  select(c(Strain, Sig_nm2psii, PARPhotonDose_day))
model_56_127St<-summary(lm(Sig_nm2psii ~ PARPhotonDose_day + Strain + PARPhotonDose_day:Strain,data=SolFits56_127St))
...
SolFits48_127St<-SolFitsExpFitAll %>%
  ...
  filter(Strain == "PE-rich_048" | Strain == "PE-rich_127") %>% 
  select(c(Strain, Sig_nm2psii, PARPhotonDose_day))
model_48_127St<-summary(lm(Sig_nm2psii ~ PARPhotonDose_day + Strain + PARPhotonDose_day:Strain,data=SolFits48_127St))
...
SolFits77_48St<-SolFitsExpFitAll %>%
  ...
  filter(Strain == "PC-rich_077" | Strain == "PE-rich_048") %>% 
  select(c(Strain, Sig_nm2psii, PARPhotonDose_day))
model_77_48St<-summary(lm(Sig_nm2psii ~ PARPhotonDose_day + Strain + PARPhotonDose_day:Strain,data=SolFits77_48St))
...
# x <- cbind(SolFits77_127St, t(as.numeric(coefficients(fit))), t(as.numeric(summary(fit)$coefficients[, 4])), summary(fit)$r.squared)
