...
Plot<-GScatalogAll %>%
  ...
  #filter(meanGS<3) %>% 
  ggplot() +
  geom_point(aes(x = PARPhotonDose, y = GS, colour = as.factor(Par_ue), shape = as.factor(Photoperiod)), size = 3.5, alpha = 0.8, show.legend = T) +
  # geom_errorbar(aes(x = PARPhotonDose, ymin = meanGS_h - sdGS_h, ymax = meanGS_h + sdGS_h, colour = as.factor(Par_ue)), show.legend = F) +
...
Plot<-GScatalogAll %>%
  ...
  filter(meanAccLen>0) %>% 
  ggplot() +
  geom_point(aes(x = PARPhotonDose, y = AccLen, colour = as.factor(Par_ue), shape = as.factor(Photoperiod)), size = 3.5, alpha = 0.8, show.legend = T) +
    geom_smooth(aes(x = PARPhotonDose, y = AccLen, colour = as.factor(Par_ue)), size = 0.7, alpha = 0, method = lm, show.legend = F) +
  # geom_errorbar(aes(x = PARPhotonDose, ymin = meanGS_h - sdGS_h, ymax = meanGS_h + sdGS_h, colour = as.factor(Par_ue)), show.legend = F) +
...
# OLISSpectraMeta440 <- OLISSpectraMeta440All %>% 
...
# OLISSPigment <- OLISSpectraMeta650 %>%
#   select(-c(SumAb, SumAbNorm, AbsNorm440, Abs440)) 
# 
# rm(Absorbance665, Absorbance650, Absorbance620, Absorbance565, Absorbance480, OLISSpectraMeta620, OLISSpectraMeta565, OLISSpectraMeta480, OLISSpectraMeta665, OLISSpectraMeta440, OLISSpectraMeta650)
```
...
```{r}
# OLISAllPURShortPhase$facetsPhotonDOse = factor(OLISAllPURShortPhase$WL, labels = c("PAR~photon~dose~(µmol~photons~m^{-2}~d^{-1})"))
```
...
Plot <- OLISAllPURShortPhase %>%
  ...
  geom_smooth(aes(x = PARPhotonDose, y = PURPARRatio, colour = as.factor(Par_ue)), size = 0.7, alpha = 0, show.legend = F) +
...
!there are negative value of pigments - fix this Sylwia!
...
Plot -> pigments per cell - photoperiod and PAR or PAR PhotonDose
```{r fig.height = 8, fig.width = 8}
...
Plot <- MultiCultiPigmentMaxAll %>%
  ...
  filter(Chlapgcell>=0) %>% 
  ggplot() +
  geom_point(aes(x = PARPhotonDose, y = Phycopgcell, colour = as.factor(Par_ue), shape = as.factor(Photoperiod)), alpha = 0.9, size = 3, show.legend = T) +
...
Plot <- MultiCultiPigmentMaxAll %>%
  ...
  filter(Chlapgcell>=0) %>% 
  ggplot() +
  geom_point(aes(x = PARPhotonDose, y = Chlapgcell, colour = as.factor(Par_ue), shape = as.factor(Photoperiod)), alpha = 0.9, size = 3, show.legend = T) +
  # geom_smooth(aes(x = E_hours, y = Chlapgcell, colour = as.factor(Par_ue)), alpha = 0, size = 1, show.legend = F) +
  # geom_line(aes(x = E_hours, y = PURPARRatio, colour = as.factor(Par_ue)), alpha = 0.9, size = 0.7, show.legend = F) +
  scale_shape_manual(values = c(15, 16, 17, 18), name="", labels = lab2) +
  scale_colour_manual(values = c("darkslategray", "lightblue4", "hotpink4", "indianred3", "orange1"), name="", labels = lab3) +
  # scale_colour_discrete(type=c("seagreen4", "palegreen3", "brown1", "brown4"), name="", labels = lab1) +
...
Plot <- MultiCultiPigmentMaxAll %>%
  ...
  ggplot() +
  # geom_smooth(aes(x = Time_h, y = PURPARRatio, colour = as.factor(Strain)),  alpha = 0, size = 0.2, linetype = "solid", show.legend = T) +
  geom_point(aes(x = E_hours, y = Phycopgcell, colour = as.factor(Strain)), alpha = 0.9, size = 3, show.legend = T) +
  # geom_vline(data = data_vline5, aes(xintercept = value), linetype="dotdash", colour = "brown4") +
  # geom_vline(data = data_vline6, aes(xintercept = value), linetype="dotdash", colour = "brown1") +
  # geom_vline(data = data_vline7, aes(xintercept = value), linetype="dotdash", colour = "seagreen4") +
  # geom_vline(data = data_vline8, aes(xintercept = value), linetype="dotdash", colour = "palegreen3") +
...
Plot -> pigments ratio - photoperiod and PAR or PAR PhotonDose
...
Plot <- MultiCultiPigmentMaxAll %>%
  filter(Par_ue!= 600) %>% 
  ggplot() +
  geom_point(aes(x = E_hours, y = CarChlaRatio, colour = as.factor(Par_ue), shape = as.factor(Photoperiod)), alpha = 0.9, size = 3, show.legend = T) +
...
Plot <- MultiCultiPigmentMaxAll %>%
  ...
  ggplot() +
  # geom_smooth(aes(x = Time_h, y = PURPARRatio, colour = as.factor(Strain)),  alpha = 0, size = 0.2, linetype = "solid", show.legend = T) +
  geom_point(aes(x = E_hours, y = PhycoChlaRatio, colour = as.factor(Strain)), alpha = 0.9, size = 3, show.legend = T) +
  # geom_vline(data = data_vline5, aes(xintercept = value), linetype="dotdash", colour = "brown4") +
  # geom_vline(data = data_vline6, aes(xintercept = value), linetype="dotdash", colour = "brown1") +
  # geom_vline(data = data_vline7, aes(xintercept = value), linetype="dotdash", colour = "seagreen4") +
  # geom_vline(data = data_vline8, aes(xintercept = value), linetype="dotdash", colour = "palegreen3") +
...
#   mutate(meanSig_nm2psii = meanSig_m2psii*1000000000000000000) %>% 
#   mutate(sdSig_nm2psii = sdSig_m2psii*1000000000000000000)
```
...
choose only exp data from sigma and JVPSII
```{r}
...
SolFitsAllChoosenExp2 <-rbind(O1, O2, O3, O4, O5, O6, O7, O8, O9)
...
SolFitsAllChoosenExp2 - contained only exp data
...
```{r}
#colnames(SolFitsAllChoosenExp2)
#SolFitsAllChoosen<-SolFitsAllChoosen %>% -contained all solisense data 

SolFitsAllChoosenExp2<-SolFitsAllChoosenExp2 %>% 

  group_by(Strain, Ex_WL, Par_ue, Photoperiod) %>%

  summarize(CultureID, Ex_WL, Par_ue, Photoperiod, WL, O2, Filename, Run, Strain, InnocDate, ExpDate, PARPhotonDose, DATE, MDcellsL, meanMDcellsL, sdMDcellsL, TurnerChl_ugL, meanTurnerChl_ugL, sdTurnerChl_ugL, ObsDate, ObsDateTime, Step_s, Dark1s, ActPAR, ActPARCorr, ActPARCorr_photonsm2s, LR_s, Fo, Fm, FvFm, Sig, Sig_m2psii, Sig_nm2psii, meanSig, sdSig, meanSig_nm2psii, sdSig_nm2psii, Fodark, Fomin, Sigdark, Sigmax, FoOxbo, ETRCtauav, ETRqpOxbo,
...
# SolFitsAllChoosenExp2<-SolFitsAllChoosenExp2 %>% 
#   mutate(AllmeanSig_nm2psii= AllmeanSig_m2psii*1000000000000000000) %>% 
#   mutate(AllsdSig_nm2psii= AllsdSig_m2psii*1000000000000000000) %>% 
#   mutate(meanSig_nm2psii= meanSig_m2psii*1000000000000000000) %>% 
#   mutate(sdSig_nm2psii= sdSig_m2psii*1000000000000000000) 
...
Plot<-SolFitsAllChoosenExp2 %>% 
  ...
  #labs(y=expression(paste(sigma,""["PSII"]*"'(m"^"2"*")")), x = "Elapsed time (h)") +
...
Plot<-SolFitsAllChoosenExp2 %>% 
  ...
  geom_errorbar(aes(x = PARPhotonDose, ymin = meanSig_nm2psii - sdSig_nm2psii, ymax = meanSig_nm2psii + sdSig_nm2psii)) +
...
Plot<-SolFitsAllChoosenExp2 %>%
  ggplot() +
  geom_point(aes(x = Par_ue, y = meanSig_nm2psii, colour = as.factor(Photoperiod)), size = 3.5, show.legend = T) +
  ggh4x::facet_nested(cols = vars(Ex_WL), rows = vars(facetsStrain, Strain), labeller = label_parsed) +
  theme_bw() +
  theme(panel.grid.minor = element_blank(),
        panel.grid.major = element_blank(),
        axis.text = element_text(size=12),
...
one phase decay
I made fit for all sig - without mean to have more points

multiple curves PAR photon Dose 590
```{r}

SolFitsAllfit590 <-SolFitsAllChoosenExp2 %>% 
  # filter(E_days<10) %>% 
  filter(E_days !=2) %>%
  filter(E_days !=3) %>%
  #filter(Strain == "PC-rich_077") %>% 
  filter(Ex_WL == 590) %>% 
  select(c(Sig_nm2psii, PARPhotonDose, Photoperiod, Par_ue, Strain, Ex_WL)) %>% 
  mutate(y=Sig_nm2psii) %>% 
...
Plot sigma vs photondose - mean all days and replica and mean only replica (shows different days)

Looks weird - fix this Sylwia!!!
```{r fig.height = 8, fig.width = 8, warning = FALSE}
...
lab2=c(expression("30 µE"), expression("90 µE"), expression("180 µE"), expression("300 µE"), expression("900 µE"))
  ...
  ggplot(SolFitsAllChoosenExp2, aes(x = PARPhotonDose, y = AllmeanSig_nm2psii)) +
  geom_point(aes(x = PARPhotonDose, y = AllmeanSig_nm2psii, colour = as.factor(Par_ue), shape = as.factor(Photoperiod)), size = 3.5, show.legend = T) +
  geom_errorbar(aes(x = PARPhotonDose, ymin = AllmeanSig_nm2psii - AllsdSig_nm2psii, ymax = AllmeanSig_nm2psii + AllsdSig_nm2psii, colour=as.factor(Par_ue))) +
  ...
  ggplot(SolFitsAllChoosenExp2, aes(x = PARPhotonDose, y = meanSig_nm2psii)) +
  geom_point(aes(x = PARPhotonDose, y = meanSig_nm2psii, colour = as.factor(Par_ue), shape = as.factor(Photoperiod)), size = 3.5, show.legend = T) +
...
sigma vs pigments
Issue - if I join E_days and E_hours then I have missing data - not always pigment based on Olis correspond to Solisense data->
maybe if I combine with only selected exp data I dont have this problem?

Later - come back to OD680data from Multiculti and choose cell/ml corresponding with day of sigma and JVPSII!!! Before calculations! Fix this Sylwia!!!!!
```{r}
#colnames(MaxGrowthExpSt)

#SolFitsAll2 <-SolFitsAllChoosenExp2
#select(-c(E_days, Time_h))

#select(-c(facets,facets2)) 
  
# 
# SolFitsAllPigment <- SolFitsAll2 %>%
#   left_join(., MultiCultiPigmentMax, by = c("Run"="Run","CultureID"="ID","Strain"="Strain","ExpDate"="ExpDate","Par_ue"="Par_ue","Photoperiod"="Photoperiod","O2"="O2","WL"="WL","PARPhotonDose"="PARPhotonDose", "E_days"="MultiDay", "Time_h"="Time_h")) 
#"ObsDate"="OlisDate"

 

# SolFitsAllPigment <- SolFitsAll2 %>% 
#   left_join(., MultiCultiPigmentMaxAllExp, by = c("Run"="Run","CultureID"="ID","Strain"="Strain","InnocDate"="InnocDate","ExpDate"="ExpDate","Par_ue"="Par_ue","Photoperiod"="Photoperiod","O2"="O2","WL"="WL","PARPhotonDose"="PARPhotonDose", "facetsStrain" = "facetsStrain")) 

#"E_days"="E_days", "Time_h"="E_hours", 
#MultiCultiPigmentMaxAllExp



SolFitsAllPigment <- SolFitsAllChoosenExp2 %>% 
...
```{r}
# SolFitsAllPigmentTurnertest<-SolFitsAllPigment %>%
#   filter(Strain == "PE-rich_127") %>%
#   filter(Par_ue == 900) %>%
#   filter(Photoperiod == 24)
```
...
Filter a few data points where pigments have negative value - fix this sylwia later!
```{r}
SolFitsAllPigmentFit<-SolFitsAllPigment %>% 
  filter(PhycopgcellExp>=0) %>% 
  filter(ChlapgcellExp>=0) %>% 
  filter(PhycoChlaRatioExp>=0) 
...
```{r platt fit}
SolFitsAllPigmentfitPhyco <- SolFitsAllPigmentFit |>  
  #select(c(Strain, Par_ue, Photoperiod, Ex_WL, meanSig_nm2psii, PhycopgcellExp, ChlapgcellExp, O2, WL)) |> 
...
```{r platt fit}
SolFitsAllPigmentfitChla <- SolFitsAllPigmentFit |>  
  select(c(Strain, Par_ue, Photoperiod, Ex_WL, AllmeanSig_nm2psii, PhycopgcellExp, ChlapgcellExp, PhycoChlaRatioExp, O2, WL)) |> 
  #filter(Ex_WL !=445) |> 
  #filter(Strain!="PE-rich_048") |> 
  nest(data = -c("Strain", "Ex_WL")) |>  
...
```{r platt fit}
SolFitsAllPigmentfitPhycoChla <- SolFitsAllPigmentFit |>  
  select(c(Strain, Par_ue, Photoperiod, Ex_WL, AllmeanSig_nm2psii, PhycopgcellExp, ChlapgcellExp, PhycoChlaRatioExp, O2, WL)) |> 
  #filter(Ex_WL !=445) |> 
  #filter(Strain!="PE-rich_048") |> 
  nest(data = -c("Strain", "Ex_WL")) |>  
...
Fix this Sylwia!
```{r linear fit}
SolFitsAllPigmentfitPhycoChlalinear <- SolFitsAllPigmentFit |>  
  select(c(Strain, Par_ue, Photoperiod, Ex_WL, Sigdark, PhycopgcellExp, ChlapgcellExp, PhycoChlaRatioExp, O2, WL)) |> 
  #filter(Ex_WL !=445) |> 
  #filter(Strain!="PE-rich_048") |> 
  nest(data = -c("Par_ue", "Ex_WL")) |>  
  mutate(Linear_Model = map(data, ~lm(Sigdark ~ PhycoChlaRatioExp,
                                                    data = .x))
                                                    # start = list(a = 1/10, b = 2/10, Pmax = 8),
                                                    # lower = c(0, 0, 0)))
                                                    #upper = c(1,1,100)), 
...
SolFitsAllPigmentfitPhyco  %>%
  ...
  ggplot(SolFitsAllPigmentFit, aes(x = PhycopgcellExp, y = AllmeanSig_nm2psii)) +
  geom_point(aes(x = PhycopgcellExp, y = AllmeanSig_nm2psii, colour = as.factor(Par_ue), shape = as.factor(Photoperiod)), size = 3.5, show.legend = T) + 
  geom_errorbar(aes(x = PhycopgcellExp, ymin = AllmeanSig_nm2psii - AllsdSig_nm2psii, ymax = AllmeanSig_nm2psii + AllsdSig_nm2psii, colour=as.factor(Par_ue))) +
...
SolFitsAllPigmentfitChla  %>%     
  ...
  ggplot(SolFitsAllPigmentFit, aes(x = ChlapgcellExp, y = AllmeanSig_nm2psii)) +
  geom_point(aes(x = ChlapgcellExp, y = AllmeanSig_nm2psii, colour = as.factor(Par_ue), shape = as.factor(Photoperiod)), size = 3.5, show.legend = T) +   
  geom_errorbar(aes(x = ChlapgcellExp, ymin = AllmeanSig_nm2psii - AllsdSig_nm2psii, ymax = AllmeanSig_nm2psii + AllsdSig_nm2psii, colour=as.factor(Par_ue))) +
...
#SolFitsAllPigmentfitPhycoChlalinear  %>%
  ...
  ggplot() +
  geom_point(aes(x = PhycoChlaRatioExp, y = Sigdark, colour=as.factor(Strain)), size = 3.5, show.legend = T, SolFitsAllPigmentFit) + 
  # geom_errorbar(aes(x = PhycoChlaRatioExp, ymin = AllmeanSig_nm2psii - AllsdSig_nm2psii, ymax = AllmeanSig_nm2psii + AllsdSig_nm2psii, colour=as.factor(Par_ue))) +
...
#Based on Anova - every parameters and fit are significantly different for each strain.
#I also obtained significant difference for each strain using Kruskal test for fitted data
...
Plot<-SolFitsAllPigment %>% 
  filter(Ex_WL==445) %>% 
ggplot() +
  geom_point(aes(AllmeanJVPSII_aLHIIOxbomax, meandeltaOD_Lmu_corr, colour=as.factor(Strain)), alpha = 0.9, size = 3.5, show.legend = T) +
#   geom_errorbar(aes(x = PhotonDose_value, ymin = deltaOD_Lmu_corr - deltaOD_Lmu_se, ymax = deltaOD_Lmu_corr + deltaOD_Lmu_se, colour = as.factor(Par_ue)), width=4000000, data = . %>% filter(deltaOD_Lmu_se<8.057558e-03), show.legend = F) +
  # scale_y_continuous(breaks=seq(0, 0.25, by = 0.1)) +
  # coord_cartesian(ylim = c(0, 0.25)) +
  scale_x_continuous(label=scientific_10) +
...
Plot<-SolFitsAllPigment %>% 
  filter(Ex_WL==445) %>% 
ggplot() +
  geom_point(aes(AllmeanJVPSII_ETRtauav_FoSig, meandeltaOD_Lmu_corr, colour=as.factor(Strain)), alpha = 0.9, size = 3.5, show.legend = T) +
  scale_x_continuous(label=scientific_10) +
  scale_colour_discrete(type=c("seagreen4", "palegreen3", "brown1", "brown4")) +
    ggh4x::facet_nested(cols = vars(Photoperiod), rows = vars(Par_ue), labeller = label_parsed) +
  theme_bw() +
...
Plot<-SolFitsAllPigment %>% 
  filter(Ex_WL==445) %>% 
ggplot() +
  geom_point(aes(AllmeanJVPSII_ETRqpOxbo_FoSig, meandeltaOD_Lmu_corr, colour=as.factor(Strain)), alpha = 0.9, size = 3.5, show.legend = T) +
  scale_x_continuous(label=scientific_10) +
  scale_colour_discrete(type=c("seagreen4", "palegreen3", "brown1", "brown4")) +
    ggh4x::facet_nested(cols = vars(Photoperiod), rows = vars(Par_ue), labeller = label_parsed) +
  theme_bw() +
...
Plot<-SolFitsAllPigment %>% 
  filter(Ex_WL==445) %>% 
ggplot() +
  geom_point(aes(AllmeanJVPSII_ETRtauav_aLHII_Sig, meandeltaOD_Lmu_corr, colour=as.factor(Strain)), alpha = 0.9, size = 3.5, show.legend = T) +
  scale_x_continuous(label=scientific_10) +
  scale_colour_discrete(type=c("seagreen4", "palegreen3", "brown1", "brown4")) +
    ggh4x::facet_nested(cols = vars(Photoperiod), rows = vars(Par_ue), labeller = label_parsed) +
  theme_bw() +
...
Plot<-SolFitsAllPigmentTurner %>% 
  filter(Ex_WL==445) %>% 
ggplot() +
  geom_point(aes(AllmeanJVPSII_aLHIIOxbomax_Chl, meandeltaOD_Lmu_corr, colour=as.factor(Strain)), alpha = 0.9, size = 3.5, show.legend = T) +
#   geom_errorbar(aes(x = PhotonDose_value, ymin = deltaOD_Lmu_corr - deltaOD_Lmu_se, ymax = deltaOD_Lmu_corr + deltaOD_Lmu_se, colour = as.factor(Par_ue)), width=4000000, data = . %>% filter(deltaOD_Lmu_se<8.057558e-03), show.legend = F) +
  # scale_y_continuous(breaks=seq(0, 0.25, by = 0.1)) +
  # coord_cartesian(ylim = c(0, 0.25)) +
  scale_x_continuous(label=scientific_10) +
...
Plot<-SolFitsAllPigmentTurner %>% 
  filter(Ex_WL==445) %>% 
ggplot() +
  geom_point(aes(AllmeanJVPSII_ETRtauav_FoSig_Chl, meandeltaOD_Lmu_corr, colour=as.factor(Strain)), alpha = 0.9, size = 3.5, show.legend = T) +
  scale_x_continuous(label=scientific_10) +
  scale_colour_discrete(type=c("seagreen4", "palegreen3", "brown1", "brown4")) +
    ggh4x::facet_nested(cols = vars(Photoperiod), rows = vars(Par_ue), labeller = label_parsed) +
  theme_bw() +
...
Plot<-SolFitsAllPigmentTurner %>% 
  filter(Ex_WL==445) %>% 
ggplot() +
  geom_point(aes(AllmeanJVPSII_ETRqpOxbo_FoSig_Chl, meandeltaOD_Lmu_corr, colour=as.factor(Strain)), alpha = 0.9, size = 3.5, show.legend = T) +
  scale_x_continuous(label=scientific_10) +
  scale_colour_discrete(type=c("seagreen4", "palegreen3", "brown1", "brown4")) +
    ggh4x::facet_nested(cols = vars(Photoperiod), rows = vars(Par_ue), labeller = label_parsed) +
  theme_bw() +
...
Plot<-SolFitsAllPigmentTurner %>% 
  filter(Ex_WL==445) %>% 
ggplot() +
  geom_point(aes(AllmeanJVPSII_ETRtauav_aLHII_Sig_Chl, meandeltaOD_Lmu_corr, colour=as.factor(Strain)), alpha = 0.9, size = 3.5, show.legend = T) +
  scale_x_continuous(label=scientific_10) +
  scale_colour_discrete(type=c("seagreen4", "palegreen3", "brown1", "brown4")) +
    ggh4x::facet_nested(cols = vars(Photoperiod), rows = vars(Par_ue), labeller = label_parsed) +
  theme_bw() +
...
Plot<-SolFitsAllPigmentTurner %>% 
  filter(Ex_WL==445) %>% 
ggplot() +
  geom_point(aes(AllmeanJVPSII_aLHIIOxbomax_Corrcell, meandeltaOD_Lmu_corr, colour=as.factor(Strain)), alpha = 0.9, size = 3.5, show.legend = T) +
#   geom_errorbar(aes(x = PhotonDose_value, ymin = deltaOD_Lmu_corr - deltaOD_Lmu_se, ymax = deltaOD_Lmu_corr + deltaOD_Lmu_se, colour = as.factor(Par_ue)), width=4000000, data = . %>% filter(deltaOD_Lmu_se<8.057558e-03), show.legend = F) +
  # scale_y_continuous(breaks=seq(0, 0.25, by = 0.1)) +
  # coord_cartesian(ylim = c(0, 0.25)) +
  scale_x_continuous(label=scientific_10) +
...
Plot<-SolFitsAllPigmentTurner %>% 
  filter(Ex_WL==445) %>% 
ggplot() +
  geom_point(aes(AllmeanJVPSII_ETRtauav_FoSig_Corrcell, meandeltaOD_Lmu_corr, colour=as.factor(Strain)), alpha = 0.9, size = 3.5, show.legend = T) +
  scale_x_continuous(label=scientific_10) +
  scale_colour_discrete(type=c("seagreen4", "palegreen3", "brown1", "brown4")) +
    ggh4x::facet_nested(cols = vars(Photoperiod), rows = vars(Par_ue), labeller = label_parsed) +
  theme_bw() +
...
Plot<-SolFitsAllPigmentTurner %>% 
  filter(Ex_WL==445) %>% 
ggplot() +
  geom_point(aes(AllmeanJVPSII_ETRqpOxbo_FoSig_Corrcell, meandeltaOD_Lmu_corr, colour=as.factor(Strain)), alpha = 0.9, size = 3.5, show.legend = T) +
  scale_x_continuous(label=scientific_10) +
  scale_colour_discrete(type=c("seagreen4", "palegreen3", "brown1", "brown4")) +
    ggh4x::facet_nested(cols = vars(Photoperiod), rows = vars(Par_ue), labeller = label_parsed) +
  theme_bw() +
...
Plot<-SolFitsAllPigmentTurner %>% 
  filter(Ex_WL==445) %>% 
ggplot() +
  geom_point(aes(AllmeanJVPSII_ETRtauav_aLHII_Sig_Corrcell, meandeltaOD_Lmu_corr, colour=as.factor(Strain)), alpha = 0.9, size = 3.5, show.legend = T) +
  scale_x_continuous(label=scientific_10) +
  scale_colour_discrete(type=c("seagreen4", "palegreen3", "brown1", "brown4")) +
    ggh4x::facet_nested(cols = vars(Photoperiod), rows = vars(Par_ue), labeller = label_parsed) +
  theme_bw() +
...
Plot<-SolFitsAllPigmentTurner %>% 
  filter(Ex_WL==445) %>% 
ggplot() +
  geom_point(aes(AllmeanJVPSII_aLHIIOxbomax_MDcell, meandeltaOD_Lmu_corr, colour=as.factor(Strain)), alpha = 0.9, size = 3.5, show.legend = T) +
#   geom_errorbar(aes(x = PhotonDose_value, ymin = deltaOD_Lmu_corr - deltaOD_Lmu_se, ymax = deltaOD_Lmu_corr + deltaOD_Lmu_se, colour = as.factor(Par_ue)), width=4000000, data = . %>% filter(deltaOD_Lmu_se<8.057558e-03), show.legend = F) +
  # scale_y_continuous(breaks=seq(0, 0.25, by = 0.1)) +
  # coord_cartesian(ylim = c(0, 0.25)) +
  scale_x_continuous(label=scientific_10) +
...
Plot<-SolFitsAllPigmentTurner %>% 
  filter(Ex_WL==445) %>% 
ggplot() +
  geom_point(aes(AllmeanJVPSII_ETRtauav_FoSig_MDcell, meandeltaOD_Lmu_corr, colour=as.factor(Strain)), alpha = 0.9, size = 3.5, show.legend = T) +
  scale_x_continuous(label=scientific_10) +
  scale_colour_discrete(type=c("seagreen4", "palegreen3", "brown1", "brown4")) +
    ggh4x::facet_nested(cols = vars(Photoperiod), rows = vars(Par_ue), labeller = label_parsed) +
  theme_bw() +
...
Plot<-SolFitsAllPigmentTurner %>% 
  filter(Ex_WL==445) %>% 
ggplot() +
  geom_point(aes(AllmeanJVPSII_ETRqpOxbo_FoSig_MDcell, meandeltaOD_Lmu_corr, colour=as.factor(Strain)), alpha = 0.9, size = 3.5, show.legend = T) +
  scale_x_continuous(label=scientific_10) +
  scale_colour_discrete(type=c("seagreen4", "palegreen3", "brown1", "brown4")) +
    ggh4x::facet_nested(cols = vars(Photoperiod), rows = vars(Par_ue), labeller = label_parsed) +
  theme_bw() +
...
Plot<-SolFitsAllPigmentTurner %>% 
  filter(Ex_WL==445) %>% 
ggplot() +
  geom_point(aes(AllmeanJVPSII_ETRtauav_aLHII_Sig_MDcell, meandeltaOD_Lmu_corr, colour=as.factor(Strain)), alpha = 0.9, size = 3.5, show.legend = T) +
  scale_x_continuous(label=scientific_10) +
  scale_colour_discrete(type=c("seagreen4", "palegreen3", "brown1", "brown4")) +
    ggh4x::facet_nested(cols = vars(Photoperiod), rows = vars(Par_ue), labeller = label_parsed) +
  theme_bw() +
...
SolFitsAllPigmentTurnerDayTest<-SolFitsAllPigmentTurnerDay2 %>% 
  #filter(Photoperiod ==8) %>% 
  mutate(AllmeanJVPSII_aLHIIOxbomax_Corrcell_day = case_when(Photoperiod != 24 ~ AllmeanJVPSII_aLHIIOxbomax_Corrcell*3600*Photoperiod/2,
                                                             Photoperiod == 24 ~ AllmeanJVPSII_aLHIIOxbomax_Corrcell*3600*Photoperiod))
         
         
         
         %>% 
           
  mutate(AllmeanJVPSII_ETRtauav_FoSig_Corrcell_day = AllmeanJVPSII_ETRtauav_FoSig_Corrcell*3600*8/2) %>% 
  mutate(AllmeanJVPSII_ETRqpOxbo_FoSig_Corrcell_day = AllmeanJVPSII_ETRqpOxbo_FoSig_Corrcell*3600*8/2) %>% 
  mutate(AllmeanJVPSII_ETRtauav_aLHII_Sig_Corrcell_day = AllmeanJVPSII_ETRtauav_aLHII_Sig_Corrcell*3600*8/2) %>% 
  mutate(AllmeanJVPSII_ETRqpOxbo_aLHII_Sig_Corrcell_day = AllmeanJVPSII_ETRqpOxbo_aLHII_Sig_Corrcell*3600*8/2) %>%
  mutate(meanJVPSII_aLHIIOxbomax_Corrcell_day = meanJVPSII_aLHIIOxbomax_Corrcell*3600*8/2) %>% 
  mutate(meanJVPSII_ETRtauav_FoSig_Corrcell_day = meanJVPSII_ETRtauav_FoSig_Corrcell*3600*8/2) %>% 
  mutate(meanJVPSII_ETRqpOxbo_FoSig_Corrcell_day = meanJVPSII_ETRqpOxbo_FoSig_Corrcell*3600*8/2) %>% 
  mutate(meanJVPSII_ETRtauav_aLHII_Sig_Corrcell_day = meanJVPSII_ETRtauav_aLHII_Sig_Corrcell*3600*8/2) %>% 
  mutate(meanJVPSII_ETRqpOxbo_aLHII_Sig_Corrcell_day = meanJVPSII_ETRqpOxbo_aLHII_Sig_Corrcell*3600*8/2) 


SolFitsAllPigmentTurnerDay8<-SolFitsAllPigmentTurnerDay2 %>% 
  filter(Photoperiod ==8) %>% 
  mutate(AllmeanJVPSII_aLHIIOxbomax_Corrcell_day = AllmeanJVPSII_aLHIIOxbomax_Corrcell*3600*8/2) %>% 
  mutate(AllmeanJVPSII_ETRtauav_FoSig_Corrcell_day = AllmeanJVPSII_ETRtauav_FoSig_Corrcell*3600*8/2) %>% 
  mutate(AllmeanJVPSII_ETRqpOxbo_FoSig_Corrcell_day = AllmeanJVPSII_ETRqpOxbo_FoSig_Corrcell*3600*8/2) %>% 
  mutate(AllmeanJVPSII_ETRtauav_aLHII_Sig_Corrcell_day = AllmeanJVPSII_ETRtauav_aLHII_Sig_Corrcell*3600*8/2) %>% 
  mutate(AllmeanJVPSII_ETRqpOxbo_aLHII_Sig_Corrcell_day = AllmeanJVPSII_ETRqpOxbo_aLHII_Sig_Corrcell*3600*8/2) %>%
...
SolFitsAllPigmentTurnerDay12<-SolFitsAllPigmentTurnerDay2 %>% 
  filter(Photoperiod ==12) %>% 
  mutate(AllmeanJVPSII_aLHIIOxbomax_Corrcell_day = AllmeanJVPSII_aLHIIOxbomax_Corrcell*3600*12/2) %>% 
  mutate(AllmeanJVPSII_ETRtauav_FoSig_Corrcell_day = AllmeanJVPSII_ETRtauav_FoSig_Corrcell*3600*12/2) %>% 
  mutate(AllmeanJVPSII_ETRqpOxbo_FoSig_Corrcell_day = AllmeanJVPSII_ETRqpOxbo_FoSig_Corrcell*3600*12/2) %>% 
  mutate(AllmeanJVPSII_ETRtauav_aLHII_Sig_Corrcell_day = AllmeanJVPSII_ETRtauav_aLHII_Sig_Corrcell*3600*12/2) %>% 
  mutate(AllmeanJVPSII_ETRqpOxbo_aLHII_Sig_Corrcell_day = AllmeanJVPSII_ETRqpOxbo_aLHII_Sig_Corrcell*3600*12/2) %>%
  mutate(meanJVPSII_aLHIIOxbomax_Corrcell_day = meanJVPSII_aLHIIOxbomax_Corrcell*3600*12/2) %>% 
  mutate(meanJVPSII_ETRtauav_FoSig_Corrcell_day = meanJVPSII_ETRtauav_FoSig_Corrcell*3600*12/2) %>% 
  mutate(meanJVPSII_ETRqpOxbo_FoSig_Corrcell_day = meanJVPSII_ETRqpOxbo_FoSig_Corrcell*3600*12/2) %>% 
  mutate(meanJVPSII_ETRtauav_aLHII_Sig_Corrcell_day = meanJVPSII_ETRtauav_aLHII_Sig_Corrcell*3600*12/2) %>% 
  mutate(meanJVPSII_ETRqpOxbo_aLHII_Sig_Corrcell_day = meanJVPSII_ETRqpOxbo_aLHII_Sig_Corrcell*3600*12/2) 
  
SolFitsAllPigmentTurnerDay16<-SolFitsAllPigmentTurnerDay2 %>% 
  filter(Photoperiod ==16) %>% 
  mutate(AllmeanJVPSII_aLHIIOxbomax_Corrcell_day = AllmeanJVPSII_aLHIIOxbomax_Corrcell*3600*16/2) %>% 
  mutate(AllmeanJVPSII_ETRtauav_FoSig_Corrcell_day = AllmeanJVPSII_ETRtauav_FoSig_Corrcell*3600*16/2) %>% 
  mutate(AllmeanJVPSII_ETRqpOxbo_FoSig_Corrcell_day = AllmeanJVPSII_ETRqpOxbo_FoSig_Corrcell*3600*16/2) %>% 
  mutate(AllmeanJVPSII_ETRtauav_aLHII_Sig_Corrcell_day = AllmeanJVPSII_ETRtauav_aLHII_Sig_Corrcell*3600*16/2) %>% 
  mutate(AllmeanJVPSII_ETRqpOxbo_aLHII_Sig_Corrcell_day = AllmeanJVPSII_ETRqpOxbo_aLHII_Sig_Corrcell*3600*16/2) %>%
  mutate(meanJVPSII_aLHIIOxbomax_Corrcell_day = meanJVPSII_aLHIIOxbomax_Corrcell*3600*16/2) %>% 
  mutate(meanJVPSII_ETRtauav_FoSig_Corrcell_day = meanJVPSII_ETRtauav_FoSig_Corrcell*3600*16/2) %>% 
  mutate(meanJVPSII_ETRqpOxbo_FoSig_Corrcell_day = meanJVPSII_ETRqpOxbo_FoSig_Corrcell*3600*16/2) %>% 
  mutate(meanJVPSII_ETRtauav_aLHII_Sig_Corrcell_day = meanJVPSII_ETRtauav_aLHII_Sig_Corrcell*3600*16/2) %>% 
  mutate(meanJVPSII_ETRqpOxbo_aLHII_Sig_Corrcell_day = meanJVPSII_ETRqpOxbo_aLHII_Sig_Corrcell*3600*16/2)  
  
SolFitsAllPigmentTurnerDay24<-SolFitsAllPigmentTurnerDay2 %>% 
  filter(Photoperiod ==24) %>% 
  mutate(AllmeanJVPSII_aLHIIOxbomax_Corrcell_day = AllmeanJVPSII_aLHIIOxbomax_Corrcell*3600*24) %>% 
  mutate(AllmeanJVPSII_ETRtauav_FoSig_Corrcell_day = AllmeanJVPSII_ETRtauav_FoSig_Corrcell*3600*24) %>% 
  mutate(AllmeanJVPSII_ETRqpOxbo_FoSig_Corrcell_day = AllmeanJVPSII_ETRqpOxbo_FoSig_Corrcell*3600*24) %>% 
  mutate(AllmeanJVPSII_ETRtauav_aLHII_Sig_Corrcell_day = AllmeanJVPSII_ETRtauav_aLHII_Sig_Corrcell*3600*24) %>% 
  mutate(AllmeanJVPSII_ETRqpOxbo_aLHII_Sig_Corrcell_day = AllmeanJVPSII_ETRqpOxbo_aLHII_Sig_Corrcell*3600*24) %>%
  mutate(meanJVPSII_aLHIIOxbomax_Corrcell_day = meanJVPSII_aLHIIOxbomax_Corrcell*3600*24) %>% 
  mutate(meanJVPSII_ETRtauav_FoSig_Corrcell_day = meanJVPSII_ETRtauav_FoSig_Corrcell*3600*24) %>% 
  mutate(meanJVPSII_ETRqpOxbo_FoSig_Corrcell_day = meanJVPSII_ETRqpOxbo_FoSig_Corrcell*3600*24) %>% 
  mutate(meanJVPSII_ETRtauav_aLHII_Sig_Corrcell_day = meanJVPSII_ETRtauav_aLHII_Sig_Corrcell*3600*24) %>% 
  mutate(meanJVPSII_ETRqpOxbo_aLHII_Sig_Corrcell_day = meanJVPSII_ETRqpOxbo_aLHII_Sig_Corrcell*3600*24) 
  
  
SolFitsAllPigmentTurnerDay<-rbind(SolFitsAllPigmentTurnerDay8, SolFitsAllPigmentTurnerDay12, SolFitsAllPigmentTurnerDay16, SolFitsAllPigmentTurnerDay24)
