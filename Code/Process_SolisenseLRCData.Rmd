...
```{r JVPSII calib}
JVPSII_eLs <- read_rds(file.path("..","Data", "CleanedData", "JVPSIIO2Calib", "JVPSII_eLs_ModelTerms.Rds"))

#smarter way to code this with 'which' in []
SolFitsMetaRaw <- SolFitsMetaRaw %>% 
  mutate(JVPSII_eLs = case_when(Ex_WL == 445 ~ JVPSII_ETRqpOxbo_FoSigmax_m2psii / JVPSII_eLs$Slope[JVPSII_eLs$Ex_WL == 445 ] - JVPSII_eLs$Intercept[JVPSII_eLs$Ex_WL == 445 ]))
```
