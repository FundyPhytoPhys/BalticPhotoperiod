...
SolFitsMetaLRCGrowth <- SolFitsMetaLRC |>
  ...
  mutate(JVPSII_umol_eLs_Par_ue = grcplatt(I = Par_ue, a = estimate_a, estimate_b, estimate_Pmax),
         JVPSII_umol_eLs_HalfPar_ue = grcplatt(I = (0.5*Par_ue), a = estimate_a, estimate_b, estimate_Pmax))
