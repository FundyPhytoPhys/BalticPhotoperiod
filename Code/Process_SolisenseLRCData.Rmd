...
SolFitsMeta <- SolFitsMeta |>
  select(-c(JVPSII_aLHIIOxbomax, JVPSII_ETRtauav_FoSig, JVPSII_ETRtauav_aLHII_Sig, JVPSII_ETRqpOxbo_aLHII_Sig)) |>
...
test <- SolFitsMeta %>% 
  ...
  mutate(JVPSII_eLs = JVPSII_ETRqpOxbo_FoSigmax_m2psii/100000)
...
SolFitsMeta <- SolFitsMeta %>% 
  mutate(Ex_WL = as.numeric(Ex_WL)) |>
  mutate(JVPSII_eLs = case_when(Ex_WL == 445 ~ JVPSII_ETRqpOxbo_FoSigmax_m2psii/JVPSII_eLs_ModelTerms$Slope[JVPSII_eLs_ModelTerms$Ex_WL == 445],
                                Ex_WL == 470 ~ JVPSII_ETRqpOxbo_FoSigmax_m2psii/JVPSII_eLs_ModelTerms$Slope[JVPSII_eLs_ModelTerms$Ex_WL == 470],
                                 Ex_WL == 505 ~ JVPSII_ETRqpOxbo_FoSigmax_m2psii/JVPSII_eLs_ModelTerms$Slope[JVPSII_eLs_ModelTerms$Ex_WL == 505],
                                 Ex_WL == 535 ~ JVPSII_ETRqpOxbo_FoSigmax_m2psii/JVPSII_eLs_ModelTerms$Slope[JVPSII_eLs_ModelTerms$Ex_WL == 535],
                                 Ex_WL == 590 ~ JVPSII_ETRqpOxbo_FoSigmax_m2psii/JVPSII_eLs_ModelTerms$Slope[JVPSII_eLs_ModelTerms$Ex_WL == 590],
                                )
  )
...
SolFitsMeta %>%
  ggplot() +
  geom_point(aes(x = ActPARCorr, y = JVPSII_eLs, colour = as.factor(Strain)), size = 3.5, show.legend = T) +
  scale_colour_discrete(type=c("seagreen4", "palegreen3", "brown1", "brown4"), name="", labels = lab1) +
