...
```{r read locally stored metadata from rds}
LIFT445_0 <- read.csv(file = file.path("..", "Data", "RawData", "SolisenseCurveData", "PICO_202201051339_SySl1073_445_data_dark.Rds"))
LIFT445_80 <- read.csv(file = file.path("..", "Data", "RawData", "SolisenseCurveData", "PICO_202201051339_SySl1073_445_data_light80.Rds"))
LIFT590_0 <- read.csv(file = file.path("..", "Data", "RawData", "SolisenseCurveData", "PICO_202201051438_SySl1073_590_data_dark.Rds"))
LIFT590_80 <- read.csv(file = file.path("..", "Data", "RawData", "SolisenseCurveData", "PICO_202201051438_SySl1073_590_data_light80.Rds"))
