...
Plota<-LIFTMeta %>%
  ...
  geom_text(data=data_textA, aes(x=1000, y=500, label=label), size=4.5) +
  
  geom_text(data=data_textSat, aes(x=100, y=100, label=label), size=3.5) +
  geom_text(data=data_textRel, aes(x=500, y=100, label=label), size=3.5) +
  geom_text(data=data_textSat1, aes(x=100, y=60, label=label), size=3.5) +
  geom_text(data=data_textRel1, aes(x=500, y=60, label=label), size=3.5) +
  geom_text(data=data_textRel2, aes(x=500, y=40, label=label), size=3.5) +
  
  geom_text(data=data_textTao, aes(x=400, y=280, label=label), size=3.5, parse = TRUE) +
  geom_text(data=data_textTaop, aes(x=450, y=330, label=label), size=3.5, parse = TRUE) +
  
  geom_text(data=data_textFm, aes(x=350, y=390, label=label), size=3.5, parse = TRUE) +
  geom_text(data=data_textFmp, aes(x=350, y=470, label=label), size=3.5, parse = TRUE) +
  
  geom_text(data = data_textF0, aes(x = 50, y = 180, label = label), size = 3.5, parse = TRUE) +
  geom_text(data = data_textF, aes(x=50, y=230, label=label), size=3.5, parse = TRUE) +

  geom_text(data=data_textSig, aes(x=100, y=390, label=label), size=3.5, parse = TRUE) +
  geom_text(data=data_textSigp, aes(x=60, y=450, label=label), size=3.5, parse = TRUE) +
...
Plotaa<-LIFTMeta %>%
  ...
  filter(Time_us>0) %>% 
  ggplot() +
  geom_point(aes(x = Time_us, y = EM),  colour = "darkblue", alpha = 0.8, size = 2, show.legend = F) +
  geom_point(aes(x = Time_us, y = EM),  colour = "orange", alpha = 0.8, size = 2, show.legend = F, LIFTMeta590) +
  geom_line(aes(x = Time_us, y = Fit),  colour = "blue", alpha = 0.7, size = 0.7, show.legend = F, LIFTMeta445) +
  geom_line(aes(x = Time_us, y = Fit),  colour = "blue", alpha = 0.7, size = 0.7, show.legend = F, LIFTMeta590) +
  geom_vline(xintercept = 250, linetype="dashed", col="black", lwd=0.2) +
  
  geom_text(data=data_textA, aes(x=1000, y=2000, label=label), size=4.5) +
  
  geom_text(data=data_textSat, aes(x=100, y=-80, label=label), size=3.5) +
  geom_text(data=data_textRel, aes(x=500, y=-80, label=label), size=3.5) +
  geom_text(data=data_textSat1, aes(x=100, y=-200, label=label), size=3.5) +
  geom_text(data=data_textRel1, aes(x=500, y=-200, label=label), size=3.5) +
  ...
  geom_text(data=data_textFm, aes(x=350, y=480, label=label), size=3.5, parse = TRUE) +
  geom_text(data=data_textFmp, aes(x=350, y=560, label=label), size=3.5, parse = TRUE) +
  
  geom_text(data = data_textF0, aes(x = 50, y = 80, label = label), size = 3.5, parse = TRUE) +
  geom_text(data = data_textF, aes(x=50, y=130, label=label), size=3.5, parse = TRUE) +

  geom_text(data=data_textSig, aes(x=30, y=420, label=label), size=3.5, parse = TRUE) +
  geom_text(data=data_textSigp, aes(x=30, y=480, label=label), size=3.5, parse = TRUE) +
...
ggplot() +
  geom_point(aes(ActPARCorr, JVPSII_umol_eLs_umolChla), colour = "brown1", alpha = 0.8, size = 2, show.legend = F) +
  geom_line(aes(ActPARCorr, .fitted), colour = "blue", linetype = "solid", size = 0.4) +
  geom_text(data=data_textC, aes(x=800, y=0.4, label=label), size=4.5) +
  #labs(y = ""~italic(JV)~""["PSII"]*" ("~10^18~""~e^-~""~L^-1~""~s^-1~")", x = "Actinic PAR ( µmol photons "~m^-2~""~s^-1~")") +
  labs(y = ""~italic(JV)~""["PSII"]*" (µmol"~e^-~""~µmol~Chl~italic(a)~""^-1~""~s^-1~")", x = "Actinic PAR ( µmol photons "~m^-2~""~s^-1~")") +
  #ggh4x::facet_nested(rows = vars(facetsExcitation, Ex_WL), labeller = label_parsed) +
  theme_bw() +
...
Plotcc<-SolTurnerMDPicoLRC2 %>%  
  ...
  filter(E_days == 14) %>%
ggplot() +
  geom_point(aes(ActPARCorr, JVPSII_umol_eLs_umolChla), colour = "darkblue", alpha = 0.8, size = 2, show.legend = F) +
  geom_point(aes(ActPARCorr, JVPSII_umol_eLs_umolChla), colour = "orange", alpha = 0.8, size = 2, show.legend = F, SolTurnerMDPicoLRC2590) +
  geom_line(aes(ActPARCorr, .fitted), colour = "blue", linetype = "solid", size = 0.4) +
  geom_line(aes(ActPARCorr, .fitted), colour = "blue", linetype = "solid", size = 0.4, SolTurnerMDPicoLRC2590) +
  geom_text(data=data_textC, aes(x=800, y=0.8, label=label), size=4.5) +
...
Plotb<-O2FRRfMetaModels %>%
  ...
  geom_text(data=data_textB, aes(x=7.5e16, y=2.0e22, label=label), size=4.5) +
 #geom_line(aes(x = O2evln_O2ls, y = .fitted + .se.fit), colour = "grey", linetype = "dashed") +
 #geom_line(aes(x = O2evln_O2ls, y = .fitted - .se.fit), colour = "grey", linetype = "dashed") +
  geom_point(aes(x = e_Ls, y = JVPSII_ETRqpOxbo_FoSigmax_m2psii),colour = "darkblue", alpha = 0.8, size = 2.0) +
...
Plotbb<-O2FRRfMetaModels %>%
  ...
  ggplot() +
  geom_line(aes(x = e_Ls, y = .fitted), colour = "blue", linetype = "solid") +
  geom_line(aes(x = e_Ls, y = .fitted), colour = "blue", linetype = "solid", O2FRRfMetaModels590) +
  geom_text(data=data_textB, aes(x=2.8e17, y=8e22, label=label), size=4.5) +
 #geom_line(aes(x = O2evln_O2ls, y = .fitted + .se.fit), colour = "grey", linetype = "dashed") +
 #geom_line(aes(x = O2evln_O2ls, y = .fitted - .se.fit), colour = "grey", linetype = "dashed") +
  geom_point(aes(x = e_Ls, y = JVPSII_ETRqpOxbo_FoSigmax_m2psii),colour = "darkblue", alpha = 0.8, size = 2.0) +
  geom_point(aes(x = e_Ls, y = JVPSII_ETRqpOxbo_FoSigmax_m2psii),colour = "orange", alpha = 0.8, size = 2.0, O2FRRfMetaModels590) +
...
```{r save plot}
ggsave(file = file.path(FigPath, paste("Fig_LIFTABC",".png",sep = "")), height=9, width= 9.5,  dpi = 300, limitsize = TRUE)
```
...
```{r save plot}
ggsave(file = file.path(FigPath, paste("Fig_LIFTABC2",".png",sep = "")), height=10, width= 9.5,  dpi = 300, limitsize = TRUE)
```
