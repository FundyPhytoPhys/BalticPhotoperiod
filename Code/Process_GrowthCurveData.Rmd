...
Project <- "BalticPhotoperiod"
#DataOut <- file.path("..", "Data", "ProcessedData", "ProcessedGrowthRateData")
DataIn <- file.path("..", "Data", "ProcessedData", "ProcessedMCDataLogisticFit", fsep = .Platform$file.sep)
...
```{r read file}
MultiCultiGrowthFile <- "../Data/ProcessedData/ProcessedMCDataLogisticFit/20211214_PICO_MC247_RUN39_ProcessDataNestGrowthFit.Rds"
