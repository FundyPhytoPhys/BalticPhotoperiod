...
```{r save plot}
ggsave(file = file.path(FigPath, paste("SFig_GrowthCurve_Fittest",".png",sep = "")), height=9, width= 7,  dpi = 300, limitsize = TRUE)
```
...
```{r save plot}
ggsave(file = file.path(FigPath, paste("SFig_GrowthCurve_Fittestlight",".png",sep = "")), height=9, width= 7,  dpi = 300, limitsize = TRUE)
```
